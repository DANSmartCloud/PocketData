...
import GlobalStyle from "./GlobalStyle/index.mjs";
...
const ThemeProvider$1 = memo(({ children, customStylish, customToken, enableCustomFonts = true, enableGlobalStyle = true, customFonts, customTheme = {}, className, style, theme: antdTheme, ...rest }) => {
	...
	return /* @__PURE__ */ jsxs(Fragment$1, { children: [enableCustomFonts && webfontUrls?.length > 0 && webfontUrls.map((webfont) => /* @__PURE__ */ jsx(FontLoader, { url: webfont }, webfont)), /* @__PURE__ */ jsx(ThemeProvider, {
		...
		theme,
		...rest,
		children: /* @__PURE__ */ jsxs(ConfigProvider$1, { children: [enableGlobalStyle && /* @__PURE__ */ jsx(GlobalStyle, {}), /* @__PURE__ */ jsx(App, {
			className,
			style: {
				isolation: "isolate",
				minHeight: "inherit",
