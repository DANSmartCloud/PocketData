...
const CONDITION_NAME = exports.CONDITION_NAME = 'intl_date_between';
...
function condition(dataRow, _ref) {
  let [from, to] = _ref;
  const dateBefore = (0, _conditionRegisterer.getCondition)(_before.CONDITION_NAME, [to]);
  const dateAfter = (0, _conditionRegisterer.getCondition)(_after.CONDITION_NAME, [from]);
