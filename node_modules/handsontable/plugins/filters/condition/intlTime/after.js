...
const CONDITION_NAME = exports.CONDITION_NAME = 'intl_time_after';
...
function condition(dataRow, _ref) {
  let [value] = _ref;
  const dataTime = (0, _dateTime.parseToLocalTime)(dataRow.value);
  const inputTime = (0, _dateTime.parseToLocalTime)(value);
