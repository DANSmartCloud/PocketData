...
var _updateWidthsMap = /*#__PURE__*/new WeakMap();
...
class NestedHeaders extends _base.BasePlugin {
  constructor() {
     ...
     * @type {boolean}
     */
    _classPrivateFieldInitSpec(this, _updateWidthsMap, false);
    /**
    ...
    _defineProperty(this, "ghostTable", new _ghostTable.default({
      hot: this.hot,
      headersStateManager: _classPrivateFieldGet(_stateManager, this)
    }));
    /**
  ...
  enablePlugin() {
    ...
    this.addHook('beforeViewRender', () => _assertClassBrand(_NestedHeaders_brand, this, _onBeforeViewRender).call(this));
  ...
  updatePlugin() {
    ...
    _classPrivateFieldSet(_updateWidthsMap, this, true);
    super.updatePlugin();
  }
...
function _onBeforeViewRender() {
  if (_classPrivateFieldGet(_updateWidthsMap, this)) {
    this.ghostTable.setLayersCount(this.getLayersCount()).buildWidthsMap();
    _classPrivateFieldSet(_updateWidthsMap, this, false);
  }
}