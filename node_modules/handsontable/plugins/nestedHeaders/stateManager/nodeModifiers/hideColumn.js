...
function hideColumn(nodeToProcess, gridColumnIndex) {
  if (!Number.isInteger(gridColumnIndex)) {
    (0, _errors.throwWithCause)('The passed gridColumnIndex argument has invalid type.');
  }
  if (nodeToProcess.childs.length > 0) {
    (0, _errors.throwWithCause)((0, _templateLiteralTag.toSingleLine)`The passed node is not the last node on the tree. Only for\x20
