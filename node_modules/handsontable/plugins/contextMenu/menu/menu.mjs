...
import { addClass, isChildOf, getParentWindow, hasClass, setAttribute, outerHeight, removeClass } from "../../../helpers/dom/element.mjs";
  ...
  open() {
    ...
    const settings = {
      ...
      beforeOnCellMouseOver: (event, coords) => {
        _classPrivateFieldGet(_navigator, this).setPageCursorAt(coords.row);
      },
