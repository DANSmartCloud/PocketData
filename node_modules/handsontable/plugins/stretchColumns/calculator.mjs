...
function _willVerticalScrollAppear() {
  ...
  for (let row = 0; row < totalRows; row++) {
    ...
    totalHeight += (_classPrivateFieldGet2 = _classPrivateFieldGet(_hot, this).getRowHeight(row)) !== null && _classPrivateFieldGet2 !== void 0 ? _classPrivateFieldGet2 : defaultRowHeight;
