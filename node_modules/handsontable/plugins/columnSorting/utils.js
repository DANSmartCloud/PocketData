...
exports.createIntlDateCompareFunction = createIntlDateCompareFunction;
exports.createIntlTimeCompareFunction = createIntlTimeCompareFunction;
 ...
 * @returns {Function} The compare function.
 */
function createIntlDateCompareFunction(sortOrder, format, columnPluginSettings) {
  return function (value, nextValue) {
    const {
      sortEmptyCells
    } = columnPluginSettings;
    ...
    const firstDate = (0, _dateTime.parseToLocalDate)(value);
    const nextDate = (0, _dateTime.parseToLocalDate)(nextValue);
    if (firstDate === null) {
      return _sortService.FIRST_AFTER_SECOND;
    }
    if (nextDate === null) {
 ...
 * @returns {Function} The compare function.
 */
function createIntlTimeCompareFunction(sortOrder, format, columnPluginSettings) {
  return function (value, nextValue) {
    const {
      sortEmptyCells
    } = columnPluginSettings;
    ...
    const firstDate = (0, _dateTime.parseToLocalTime)(value);
    const nextDate = (0, _dateTime.parseToLocalTime)(nextValue);
    if (firstDate === null) {
      return _sortService.FIRST_AFTER_SECOND;
    }
    if (nextDate === null) {
