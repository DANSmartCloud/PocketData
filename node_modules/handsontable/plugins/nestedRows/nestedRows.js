...
var _isFirstRender = /*#__PURE__*/new WeakMap();
...
class NestedRows extends _base.BasePlugin {
  constructor() {
     ...
     * @type {boolean}
     */
    _classPrivateFieldInitSpec(this, _isFirstRender, true);
  }
  ...
  enablePlugin() {
    ...
    _classPrivateFieldSet(_isFirstRender, this, true);
    ...
    this.addHook('afterRender', function () {
      ...
      return _assertClassBrand(_NestedRows_brand, _this, _onAfterRender).call(_this, ...args);
    });
...
function _onAfterRender() {
  if (_classPrivateFieldGet(_isFirstRender, this) && this.hot.view) {
    _classPrivateFieldSet(_isFirstRender, this, false);
