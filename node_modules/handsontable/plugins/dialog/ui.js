...
var _sanitizer = /*#__PURE__*/new WeakMap();
...
class DialogUI {
  constructor(_ref) {
     ...
     */
    _classPrivateFieldInitSpec(this, _sanitizer, void 0);
    _classPrivateFieldSet(_rootElement, this, rootElement);
    _classPrivateFieldSet(_isRtl, this, isRtl);
    _classPrivateFieldSet(_sanitizer, this, sanitizer);
    this.install();
  }
  ...
  useTemplate(templateName) {
    ...
    if (!_templates.TEMPLATES.has(templateName) || templateName === 'base') {
      ...
      (0, _errors.throwWithCause)((0, _templateLiteralTag.toSingleLine)`Invalid template: ${templateName}.\x20
  ...
  updateDialog(_ref2) {
    ...
    if (_classPrivateFieldGet(_template, this).TEMPLATE_NAME === 'base') {
      ...
      if (typeof content === 'string') {
        (0, _element.fastInnerHTML)(contentElement, content, _classPrivateFieldGet(_sanitizer, this));
