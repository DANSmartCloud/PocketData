...
var dateTimeHelpers = _interopRequireWildcard(require("./helpers/dateTime"));
var errorsHelpers = _interopRequireWildcard(require("./helpers/errors"));
...
var _factory = require("./editors/factory");
var _registry3 = require("./renderers/registry");
var _factory2 = require("./renderers/factory");
...
var _registry7 = require("./themes/registry");
var _Handsontable$cellTyp, _Handsontable$editors, _Handsontable$rendere, _Handsontable$validat, _Handsontable$plugins, _Handsontable$themes;
...
const HELPERS = [arrayHelpers, browserHelpers, dataHelpers, dateTimeHelpers, errorsHelpers, featureHelpers, functionHelpers, mixedHelpers, numberHelpers, objectHelpers, stringHelpers, unicodeHelpers, parseTableHelpers];
...
_base.default.editors.editorFactory = _factory.editorFactory;
...
_base.default.renderers.rendererFactory = _factory2.rendererFactory;
...
_base.default.themes = (_Handsontable$themes = _base.default.themes) !== null && _Handsontable$themes !== void 0 ? _Handsontable$themes : {};
_base.default.themes.hasTheme = _registry7.hasTheme;
_base.default.themes.getTheme = _registry7.getTheme;
_base.default.themes.getThemeNames = _registry7.getThemeNames;
_base.default.themes.getThemes = _registry7.getThemes;
_base.default.themes.registerTheme = _registry7.registerTheme;
_base.default.themes.reinitTheme = _registry7.reinitTheme;
