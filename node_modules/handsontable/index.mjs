...
import * as dateTimeHelpers from "./helpers/dateTime.mjs";
import * as errorsHelpers from "./helpers/errors.mjs";
...
import { editorFactory } from "./editors/factory.mjs";
import { getRegisteredRendererNames, getRenderer, registerRenderer } from "./renderers/registry.mjs";
import { rendererFactory } from "./renderers/factory.mjs";
...
import { hasTheme, getTheme, getThemeNames, getThemes, registerTheme, reinitTheme } from "./themes/registry.mjs";
registerAllModules();
...
Handsontable.themes = (_Handsontable$themes = Handsontable.themes) !== null && _Handsontable$themes !== void 0 ? _Handsontable$themes : {};
