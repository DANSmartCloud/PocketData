...
var _sourceDataValidator = require("./sourceDataValidator");
...
function replaceData(data, setDataMapFunction, callbackFunction, config) {
  ...
  if (typeof data === 'object' && data !== null) {
    ...
    (0, _errors.throwWithCause)(`${internalSource} only accepts array of objects or array of arrays (${typeof data} given)`);
  }
  ...
  if (!firstRun) {
    (0, _sourceDataValidator.runSourceDataValidators)(hotInstance, internalSource);
  }
