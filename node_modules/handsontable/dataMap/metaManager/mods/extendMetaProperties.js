    ...
    _defineProperty(this, "propDescriptors", new Map([['ariaTags', {
      ...
      onChange() {
        if (!correctFormatDeprecatedMessageShown.has(this.metaManager.hot)) {
          ...
          (0, _console.deprecatedWarn)('The `correctFormat` option is deprecated and will be removed in the next major release.\n\n' + 'Migration guide: https://handsontable.com/docs/migration-from-16.2-to-17.0/');
        }
      }
    }], ['datePickerConfig', {
      onChange() {
        if (!datePickerConfigDeprecatedMessageShown.has(this.metaManager.hot)) {
          ...
          (0, _console.deprecatedWarn)('The `datePickerConfig` option is deprecated and will be removed in the next major release.\n\n' + 'Migration guide: https://handsontable.com/docs/migration-from-16.2-to-17.0/');
        }
      }
    }], ['layoutDirection', {
      initOnly: true
