...
import { isSafariBefore261, isMobileBrowser, isIpadOS, isWindowsOS } from "../browser.mjs";
 ...
 */
// eslint-disable-next-line no-restricted-globals
export function getFractionalScalingCompensation() {
...
function walkontableCalculateScrollbarWidth() {
  ...
  const calculateScrollbarWidth = function () {
    let shouldForceWebkitScrollbarStyles = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
