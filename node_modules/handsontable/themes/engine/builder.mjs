...
import { isObject, deepClone, deepMerge } from "../../helpers/object.mjs";
import sizing from "../static/variables/sizing.mjs";
import densitySizes from "../static/variables/density.mjs";
import { validateParams, validateDensityType, validateColorScheme } from "./utils/validation.mjs";
...
class ThemeBuilder {
   ...
   */
  setColorScheme(mode) {
    _classPrivateFieldSet(_colorScheme, this, validateColorScheme(mode));
   ...
   */
  setDensityType(type) {
    _classPrivateFieldSet(_densityType, this, validateDensityType(type));
...
function _setParams(paramsObject) {
  const config = deepClone(_classPrivateFieldGet(_initThemeConfig, this));
