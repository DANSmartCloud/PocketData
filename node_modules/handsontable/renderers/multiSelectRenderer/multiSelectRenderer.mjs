...
import { addClass, empty, fastInnerText } from "../../helpers/dom/element.mjs";
import { stringify } from "../../helpers/mixed.mjs";
import { parseValue, createChipElement, registerChipRemovingEvents, cacheColumnWidthAndRegisterResizeHook, handleChipsOverflow, CHIP_CLASS } from "./utils/utils.mjs";
export { CHIP_CLASS };
