...
function _getEditorInstance(name, hotInstance) {
  ...
  if (typeof name === 'function') {
    ...
    (0, _errors.throwWithCause)('Only strings and functions can be passed as "editor" parameter');
  }
  if (!editor) {
    (0, _errors.throwWithCause)(`No editor registered under name "${name}"`);
  }
...
function _getItem(name) {
  ...
  if (!hasItem(name)) {
    (0, _errors.throwWithCause)(`No registered editor found under "${name}" name`);
  }
