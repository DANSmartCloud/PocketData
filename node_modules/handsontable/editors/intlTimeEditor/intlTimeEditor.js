...
const EDITOR_TYPE = exports.EDITOR_TYPE = 'intl-time';

/**
 * @private
 * @class IntlTimeEditor
 */
class IntlTimeEditor extends _textEditor.TextEditor {
   ...
   */
  setValue(value) {
    if (!(0, _dateTime.isValidTime)(value)) {
      (0, _console.warn)((0, _templateLiteralTag.toSingleLine)`IntlTimeEditor: value must be in 24-hour time format ("HH:mm", "HH:mm:ss" or "HH:mm:ss.SSS")\x20
...
exports.IntlTimeEditor = IntlTimeEditor;