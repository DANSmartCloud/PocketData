...
import { DropdownController } from "./controllers/dropdownController.mjs";
import { SelectedItemsController } from "./controllers/selectedItemsController.mjs";
import { addClass, setAttribute } from "../../helpers/dom/element.mjs";
import { isPrintableChar } from "../../helpers/unicode.mjs";
import { A11Y_LABEL, A11Y_GROUP } from "../../helpers/a11y.mjs";
import { EDITOR_EDIT_GROUP } from "../../shortcutContexts/constants.mjs";
import { getValuesIntersection, parseStringifiedValue } from "./utils/utils.mjs";
...
export class MultiSelectEditor extends BaseEditor {
  ...
  constructor(hotInstance) {
     ...
     */
    _classPrivateFieldInitSpec(this, _selectedItems, new SelectedItemsController());
    /**
  ...
  createElements() {
    ...
    addClass(_classPrivateFieldGet(_editorContainer, this), 'handsontableEditor');
    ...
    setAttribute(this.dropdownContainerElement, [A11Y_LABEL(DROPDOWN_ARIA_LABEL), A11Y_GROUP()]);
  ...
  prepare(row, col, prop, td, value, cellProperties) {
    ...
    const valuesIntersection = getValuesIntersection(valuesArray, _assertClassBrand(_MultiSelectEditor_brand, this, _getSource).call(this));
   ...
   */
  open(event) {
    if (isPrintableChar(event === null || event === void 0 ? void 0 : event.keyCode)) {
  ...
  refreshDimensions() {
    ...
    addClass(_classPrivateFieldGet(_editorContainer, this), EDITOR_VISIBLE_CLASS_NAME);
  }
...
function _syncSelectedValues(valuesArray) {
  if (valuesArray.length > 0) {
    _classPrivateFieldSet(_selectedItems, this, new SelectedItemsController(valuesArray));
  } else {
    _classPrivateFieldSet(_selectedItems, this, new SelectedItemsController());
  }
}
/**
