...
class AutocompleteEditor extends _handsontableEditor.HandsontableEditor {
  ...
  getValue() {
    const selectedValue = this.rawChoices.find(value => {
      ...
      return ((0, _object.isKeyValueObject)(strippedValue) ? strippedValue.value : strippedValue) === this.TEXTAREA.value;
    });
  ...
  prepare(row, col, prop, td, value, cellProperties) {
    ...
    this.htOptions = {
      ...this.htOptions,
      valueGetter: cellValue => (0, _object.isKeyValueObject)(cellValue) ? cellValue.value : cellValue
    };
  }
  ...
  updateChoicesList(choicesList) {
    ...
    const comparableValue = (0, _object.isKeyValueObject)(value) ? value.value : value;
    ...
    for (let i = 0; i < choices.length; i++) {
      const currentItem = (0, _object.isKeyValueObject)(choices[i]) ? (0, _string.stripTags)((0, _mixed.stringify)(choices[i].value)) : (0, _string.stripTags)((0, _mixed.stringify)(choices[i]));
