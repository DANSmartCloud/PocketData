...
class DateEditor extends _textEditor.TextEditor {
  ...
  init() {
    if (typeof _moment.default !== 'function') {
      (0, _errors.throwWithCause)('You need to include moment.js to your project.');
    }
    if (typeof _pikaday.default !== 'function') {
      (0, _errors.throwWithCause)('You need to include Pikaday to your project.');
    }
    super.init();
  ...
  open() {
    ...
    if (!deprecatedMessageShown.has(this.cellProperties.instance)) {
      ...
      (0, _console.deprecatedWarn)('The Pikaday-based `date` editor is deprecated and will be removed in the next major release, ' + 'replaced by the native HTML date input.\n\n' + 'Migration guide: https://handsontable.com/docs/migration-from-16.2-to-17.0/\n' + '`date` cell type documentation: https://handsontable.com/docs/date-cell-type/');
    }
  ...
  refreshDimensions(force) {
    ...
    if (this.row >= firstVisibleRow && this.row <= lastVisibleRow && this.col >= firstVisibleColumn && this.col <= lastVisibleColumn) {
      ...
      const pickerWidth = (0, _element.outerWidth)(this.datePicker);
      const pickerHeight = (0, _element.outerHeight)(this.datePicker);
      const cellHeight = (0, _element.outerHeight)(this.TD);
      ...
      if (top + pickerHeight > viewportBottom) {
        ...
        top = aboveCell >= viewportTop ? Math.max(viewportTop, aboveCell - 1) : viewportBottom - pickerHeight;
      }
      ...
      pickerLeftPosition = (0, _number.clamp)(pickerLeftPosition, viewportLeft, viewportRight - pickerWidth);
