import {
  ...
  _getItem3,
  _injectProductInfo,
  _register2 as _register,
  _register4 as _register2,
  addClass,
  arrayEach,
  arrayMap,
  arrayReduce,
...
// node_modules/@handsontable/react-wrapper/es/react-handsontable.mjs
...
var DataMap = class _DataMap {
  ...
  createCol(index) {
    ...
    if (!this.hot.isColumnModificationAllowed()) {
      throwWithCause("Cannot create new column. When data source in an object, you can only have as much columns as defined in first data row, data schema or in the 'columns' setting.If you want to be able to add new columns, you have to use array datasource.");
    }
...
var DataSource = class {
  constructor(hotInstance) {
    ...
    _defineProperty4(this, "dataType", "array");
    _defineProperty4(this, "colToProp", () => {
    });
    _defineProperty4(this, "propToCol", () => {
    });
    this.hot = hotInstance;
...
var metaSchema_default = () => {
  return {
     ...
     * @category Core
     */
    sourceDataWarningMessage: void 0,
    /**
     * @description
...
// node_modules/handsontable/dataMap/sourceDataValidator.mjs
...
function runSourceDataValidators(hotInstance, source) {
  ...
  const invalidByMessageType = /* @__PURE__ */ new Map();
...
var correctFormatDeprecatedMessageShown = /* @__PURE__ */ new WeakSet();
var datePickerConfigDeprecatedMessageShown = /* @__PURE__ */ new WeakSet();
    ...
    _defineProperty11(this, "propDescriptors", /* @__PURE__ */ new Map([["ariaTags", {
      ...
      onChange(propName) {
        ...
        if (this.usageTracker.has("fixedColumnsLeft") && this.usageTracker.has("fixedColumnsStart")) {
          throwWithCause("The `fixedColumnsLeft` and `fixedColumnsStart` should not be used together. Please use only the option `fixedColumnsStart`.");
        }
      }
    }], ["correctFormat", {
      onChange() {
        if (!correctFormatDeprecatedMessageShown.has(this.metaManager.hot)) {
          ...
          deprecatedWarn("The `correctFormat` option is deprecated and will be removed in the next major release.\n\nMigration guide: https://handsontable.com/docs/migration-from-16.2-to-17.0/");
        }
      }
    }], ["datePickerConfig", {
      onChange() {
        if (!datePickerConfigDeprecatedMessageShown.has(this.metaManager.hot)) {
          ...
          deprecatedWarn("The `datePickerConfig` option is deprecated and will be removed in the next major release.\n\nMigration guide: https://handsontable.com/docs/migration-from-16.2-to-17.0/");
        }
      }
    }], ["layoutDirection", {
      initOnly: true
...
var FocusGridManager = class {
  ...
  refocusToEditorTextarea() {
    ...
    if (_classPrivateFieldGet4(_hot, this).getSettings().imeFastEdit && !((_classPrivateFieldGet52 = _classPrivateFieldGet4(_hot, this).getActiveEditor()) !== null && _classPrivateFieldGet52 !== void 0 && _classPrivateFieldGet52.isOpened())) {
      var _classPrivateFieldGet62, _classPrivateFieldGet7;
      (_classPrivateFieldGet62 = _classPrivateFieldGet4(_hot, this).getActiveEditor()) === null || _classPrivateFieldGet62 === void 0 || (_classPrivateFieldGet7 = _classPrivateFieldGet62.refreshValue) === null || _classPrivateFieldGet7 === void 0 || _classPrivateFieldGet7.call(_classPrivateFieldGet62);
...
var CORE_STYLES_ID = "handsontable-core-styles";
...
var StylesHandler = class {
  ...
  constructor(_ref) {
    ...
    if (injectCoreCss) {
      _assertClassBrand6(_StylesHandler_brand, this, _injectCoreStyles).call(this);
    }
  }
  /**
  ...
  getStyleForTD(cssProperty) {
    var _classPrivateFieldGet22;
    return (_classPrivateFieldGet22 = _classPrivateFieldGet5(_computedStyles, this)) === null || _classPrivateFieldGet22 === void 0 || (_classPrivateFieldGet22 = _classPrivateFieldGet22.td) === null || _classPrivateFieldGet22 === void 0 ? void 0 : _classPrivateFieldGet22[cssProperty];
  }
  /**
...
function _injectCoreStyles() {
  if (!_classPrivateFieldGet5(_hot2, this) || !_classPrivateFieldGet5(_rootDocument, this) || !_classPrivateFieldGet5(_rootDocument, this).head) {
    return;
  }
  const existing = _classPrivateFieldGet5(_rootDocument, this).getElementById(CORE_STYLES_ID);
  if (existing && existing instanceof HTMLStyleElement) {
    return;
  }
  const baseStyles = _classPrivateFieldGet5(_rootDocument, this).createElement("style");
  baseStyles.id = CORE_STYLES_ID;
  baseStyles.textContent = handsontableStyles_default;
  _classPrivateFieldGet5(_rootDocument, this).head.appendChild(baseStyles);
}
...
function _getCSSValue(property) {
  ...
  const acquiredValue = (_classPrivateFieldGet32 = _classPrivateFieldGet5(_rootComputedStyle, this)) === null || _classPrivateFieldGet32 === void 0 ? void 0 : _classPrivateFieldGet32.getPropertyValue(property);
...
// node_modules/handsontable/themes/static/variables/sizing.mjs
var sizing_default = {
  size_0: "0px",
  size_0_5: "2px",
  size_1: "4px",
...
// node_modules/handsontable/themes/static/variables/density.mjs
var density_default = {
  default: {
...
// node_modules/handsontable/themes/engine/utils/validation.mjs
var VALID_PARAMS_KEYS = /* @__PURE__ */ new Set(["name", "sizing", "density", "icons", "colors", "tokens", "colorScheme"]);
var VALID_COLOR_SCHEMES = /* @__PURE__ */ new Set(["light", "dark", "auto"]);
var VALID_DENSITY_TYPES = /* @__PURE__ */ new Set(["default", "compact", "comfortable"]);
var VALID_ICON_KEYS = /* @__PURE__ */ new Set(["arrowRight", "arrowRightWithBar", "arrowLeft", "arrowLeftWithBar", "arrowDown", "menu", "selectArrow", "arrowNarrowUp", "arrowNarrowDown", "check", "checkbox", "caretHiddenLeft", "caretHiddenRight", "caretHiddenUp", "caretHiddenDown", "collapseOff", "collapseOn", "radio", "chipClose", "search"]);
var VALID_TOKEN_KEYS = /* @__PURE__ */ new Set([
  // Typography
  "fontFamily",
  "fontSize",
  "fontSizeSmall",
...
function validateColorScheme(mode) {
...
function validateDensityType(type) {
...
function validateParams(parameters, context) {
  let options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
  const {
    requiredFields = []
  } = options;
...
// node_modules/handsontable/themes/engine/builder.mjs
...
var MERGEABLE_CONFIG_KEYS = ["sizing", "icons", "colors", "tokens"];
var REQUIRED_CONFIG_KEYS = ["name", "icons", "colors", "tokens"];
...
var ThemeBuilder = class {
  ...
  constructor(themeConfig) {
    _classPrivateMethodInitSpec6(this, _ThemeBuilder_brand);
    _classPrivateFieldInitSpec6(this, _initThemeConfig, void 0);
    _classPrivateFieldInitSpec6(this, _themeConfig, void 0);
    _classPrivateFieldInitSpec6(this, _listeners, /* @__PURE__ */ new Set());
    _classPrivateFieldInitSpec6(this, _colorScheme, "auto");
    _classPrivateFieldInitSpec6(this, _densityType, "default");
    validateParams(themeConfig, "themeConfig", {
      requiredFields: REQUIRED_CONFIG_KEYS
    });
    _classPrivateFieldSet5(_initThemeConfig, this, {
      name: void 0,
      sizing: sizing_default,
      density: {
        type: _classPrivateFieldGet6(_densityType, this),
        sizes: density_default
      },
      icons: {},
      colors: {},
      tokens: {},
      colorScheme: _classPrivateFieldGet6(_colorScheme, this)
    });
    _assertClassBrand7(_ThemeBuilder_brand, this, _setParams).call(this, themeConfig);
    _classPrivateFieldSet5(_initThemeConfig, this, _classPrivateFieldGet6(_themeConfig, this));
  }
  /**
  ...
  subscribe(listener) {
    ...
    _classPrivateFieldGet6(_listeners, this).add(listener);
    return () => _classPrivateFieldGet6(_listeners, this).delete(listener);
  }
  /**
  ...
  params(paramsObject) {
    ...
    _assertClassBrand7(_ThemeBuilder_brand, this, _setParams).call(this, paramsObject);
    _assertClassBrand7(_ThemeBuilder_brand, this, _notifyChange).call(this);
    return this;
  }
  /**
   ...
   */
  setColorScheme(mode) {
    _classPrivateFieldSet5(_colorScheme, this, validateColorScheme(mode));
    _classPrivateFieldGet6(_themeConfig, this).colorScheme = _classPrivateFieldGet6(_colorScheme, this);
    _classPrivateFieldGet6(_initThemeConfig, this).colorScheme = _classPrivateFieldGet6(_colorScheme, this);
    _assertClassBrand7(_ThemeBuilder_brand, this, _notifyChange).call(this);
    return this;
  }
  /**
   ...
   */
  setDensityType(type) {
    _classPrivateFieldSet5(_densityType, this, validateDensityType(type));
    _classPrivateFieldGet6(_themeConfig, this).density.type = _classPrivateFieldGet6(_densityType, this);
    _classPrivateFieldGet6(_initThemeConfig, this).density.type = _classPrivateFieldGet6(_densityType, this);
    _assertClassBrand7(_ThemeBuilder_brand, this, _notifyChange).call(this);
    return this;
  }
  /**
   ...
   */
  getThemeConfig() {
    return _classPrivateFieldGet6(_themeConfig, this);
  }
};
function _notifyChange() {
  const config = this.getThemeConfig();
  _classPrivateFieldGet6(_listeners, this).forEach((listener) => listener(config));
}
function _applyDensityConfig(config, density) {
  if (isObject(density)) {
    var _classPrivateFieldGet22;
    config.density = deepMerge(config.density, density);
    _classPrivateFieldSet5(_densityType, this, density.type);
    if ((_classPrivateFieldGet22 = _classPrivateFieldGet6(_initThemeConfig, this)) !== null && _classPrivateFieldGet22 !== void 0 && _classPrivateFieldGet22.density) {
      _classPrivateFieldGet6(_initThemeConfig, this).density.type = density.type;
    }
  } else if (typeof density === "string") {
    var _classPrivateFieldGet32;
    config.density.type = density;
    _classPrivateFieldSet5(_densityType, this, density);
    if ((_classPrivateFieldGet32 = _classPrivateFieldGet6(_initThemeConfig, this)) !== null && _classPrivateFieldGet32 !== void 0 && _classPrivateFieldGet32.density) {
      _classPrivateFieldGet6(_initThemeConfig, this).density.type = density;
    }
  }
}
function _setParams(paramsObject) {
  const config = deepClone(_classPrivateFieldGet6(_initThemeConfig, this));
  if (paramsObject.name !== void 0) {
    if (_classPrivateFieldGet6(_initThemeConfig, this).name !== void 0) {
      warn('[ThemeBuilder] The "name" property can only be set during `registerTheme()` and cannot be updated via `params()`.');
    } else {
      config.name = paramsObject.name;
    }
  }
  MERGEABLE_CONFIG_KEYS.forEach((key) => {
    if (paramsObject[key] !== void 0 && isObject(paramsObject[key])) {
      config[key] = deepMerge(config[key], paramsObject[key]);
    }
  });
  if (paramsObject.density !== void 0) {
    _assertClassBrand7(_ThemeBuilder_brand, this, _applyDensityConfig).call(this, config, paramsObject.density);
  }
  if (paramsObject.colorScheme !== void 0) {
    var _classPrivateFieldGet42;
    config.colorScheme = paramsObject.colorScheme;
    _classPrivateFieldSet5(_colorScheme, this, paramsObject.colorScheme);
    if ((_classPrivateFieldGet42 = _classPrivateFieldGet6(_initThemeConfig, this)) !== null && _classPrivateFieldGet42 !== void 0 && _classPrivateFieldGet42.colorScheme) {
      _classPrivateFieldGet6(_initThemeConfig, this).colorScheme = paramsObject.colorScheme;
    }
  }
  _classPrivateFieldSet5(_themeConfig, this, config);
}
function createTheme(baseTheme) {
  return new ThemeBuilder(baseTheme);
}

// node_modules/handsontable/themes/static/variables/helpers/iconsMap.mjs
var icon = (icons, name) => {
...
var iconsMap = (icons, themePrefix) => {
...
// node_modules/handsontable/themes/engine/utils/cssVariables.mjs
var VAR_PREFIX = "--ht-";
var CSS_KEY_EXCEPTIONS = ["font-family"];
var VAR_REFERENCE_PREFIXES = ["tokens.", "colors.", "sizing.", "density."];
...
function flattenCssVariables(cssVariables) {
  let prefix = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "";
  let parentKey = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "";
  let cssVars = "";
  Object.entries(cssVariables).forEach((_ref) => {
    let [key, value] = _ref;
...
// node_modules/handsontable/themes/engine/manager.mjs
...
var THEME_PREFIX = "ht-theme-";
var _ThemeManager_brand = /* @__PURE__ */ new WeakSet();
var ThemeManager = class {
  ...
  constructor(_ref) {
    ...
    _classPrivateMethodInitSpec7(this, _ThemeManager_brand);
    _defineProperty12(this, "hot", void 0);
    _defineProperty12(this, "themeStyles", void 0);
    _defineProperty12(this, "themeClassName", void 0);
    _defineProperty12(this, "themeConfig", void 0);
    this.hot = hot;
  ...
  update(themeObject) {
    ...
    if (themeObject.getThemeConfig === void 0) {
    ...
    if (typeof themeObject.subscribe === "function") {
      themeObject.subscribe((config) => {
        var _this$hot;
        if (!((_this$hot = this.hot) !== null && _this$hot !== void 0 && _this$hot.stylesHandler)) {
          return;
        }
        this.themeConfig = config;
        _assertClassBrand8(_ThemeManager_brand, this, _injectThemeStyles).call(this);
...
`;
  ...
  if (this.themeConfig.density && this.themeConfig.density.type && this.themeConfig.density.sizes && this.themeConfig.density.sizes[this.themeConfig.density.type]) {
    this.themeStyles.textContent += flattenCssVariables(this.themeConfig.density.sizes[this.themeConfig.density.type], "density");
  }
...
function createThemeManager(_ref2) {
  let {
    hot,
    themeObject
  } = _ref2;
...
// node_modules/handsontable/themes/static/variables/icons/main.mjs
var main_default = {
...
// node_modules/handsontable/themes/static/variables/colors/main.mjs
var main_default2 = {
  white: "#ffffffff",
  black: "#000000ff",
  primary: {
...
// node_modules/handsontable/themes/static/variables/tokens/main.mjs
var main_default3 = {
  fontFamily: "Inter",
  fontSize: "14px",
  fontSizeSmall: "12px",
...
// node_modules/handsontable/themes/theme/main.mjs
var mainTheme = {
  name: "main",
  density: "default",
  icons: main_default,
  colors: main_default2,
  tokens: main_default3
};

// node_modules/handsontable/themes/registry.mjs
var {
  hasItem,
  getItem,
  getNames,
...
function Core(rootContainer, userSettings) {
  ...
  this.stylesHandler = new StylesHandler({
    ...
    onThemeChange: (themeName2) => {
      if (isRootInstance(this)) {
        var _this$view;
        removeClass(this.rootWrapperElement, /ht-theme-.*/g);
        removeClass(this.rootPortalElement, /ht-theme-.*/g);
        if (themeName2) {
          addClass(this.rootWrapperElement, themeName2);
          addClass(this.rootPortalElement, themeName2);
          if (!getComputedStyle(this.rootWrapperElement).getPropertyValue("--ht-line-height")) {
            warn(`The "${themeName2}" theme is enabled, but its stylesheets are missing or not imported correctly. Import the correct CSS files in order to use that theme.`);
          }
        }
  ...
  function initializeThemeManager(theme2) {
    let themeObject;
    if (typeof theme2 === "undefined") {
      if (hasTheme("main")) {
      ...
      themeObject = getTheme("main");
    } else if (typeof theme2.getThemeConfig !== "function") {
      themeObject = registerTheme(theme2);
    } else {
      themeObject = theme2;
    }
  ...
  this.populateFromArray = function(row, column, input, endRow, endCol, source, method) {
    if (!(typeof input === "object" && typeof input[0] === "object")) {
      throwWithCause("populateFromArray parameter `input` must be an array of arrays");
    }
  ...
  this.updateSettings = function(settings) {
    ...
    const rootContainerThemeClassName2 = getThemeClassName(instance.rootContainer);
    ...
    if (init) {
      ...
      if (themeOptionExists && typeof settings.theme === "string") {
        themeName2 = settings.theme;
      } else if (themeNameOptionExists && typeof settings.themeName === "string" && settings.themeName && !themeOptionExists) {
        themeName2 = settings.themeName;
        tableMeta.theme = settings.themeName;
        tableMeta.themeName = void 0;
      } else if (rootContainerThemeClassName2) {
        themeName2 = rootContainerThemeClassName2;
      } else if (instance.themeManager) {
        themeName2 = instance.themeManager.getClassName();
      }
      instance.useTheme(themeName2);
    } else {
      ...
      } else if (isRootInstance(instance) && !rootContainerThemeClassName2 && isObject(settings.theme)) {
  ...
  this.timeouts = [];
  this.useTheme = (themeName2) => {
    const isFirstRun = !!firstRun;
    this.stylesHandler.useTheme(themeName2);
...
_register2(TextCellType);
_register(baseRenderer);
...
function displayObsoleteRenderersEditorsWarning(children) {
  if (hasChildElementOfType(children, "hot-renderer")) {
    warn2(OBSOLETE_HOTRENDERER_WARNING);
    return true;
  }
  if (hasChildElementOfType(children, "hot-editor")) {
    warn2(OBSOLETE_HOTEDITOR_WARNING);
    return true;
  }
  return false;
}
function displayChildrenOfTypeWarning(children, Component) {
  ...
  if (childrenArray.some(function(child) {
    ...
    warn2(UNEXPECTED_HOTTABLE_CHILDREN_WARNING);
    return true;
  }
  return false;
}
function displayAnyChildrenWarning(children) {
  ...
  if (childrenArray.length) {
    warn2(UNEXPECTED_HOTCOLUMN_CHILDREN_WARNING);
    return true;
  }
  return false;
}
...
function createEditorPortal(doc, Editor) {
  ...
  var editorElement = import_react.default.createElement(Editor, null);
...
function createPortal(rElement) {
  var ownerDocument = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : document;
  var portalKey = arguments.length > 2 ? arguments[2] : void 0;
  var cachedContainer = arguments.length > 3 ? arguments[3] : void 0;
  if (!ownerDocument) {
  ...
  return {
    portal: import_react_dom.default.createPortal(rElement, portalContainer, portalKey),
    portalContainer
  };
}
...
function useUpdateEffect(effect, deps) {
  var notInitialRender = import_react.default.useRef(false);
...
var HotTableContext = (0, import_react.createContext)(void 0);
var HotTableContextProvider = function HotTableContextProvider2(_ref) {
  var children = _ref.children;
  var columnsSettings = (0, import_react.useRef)([]);
  var setHotColumnSettings = (0, import_react.useCallback)(function(columnSettings, columnIndex) {
    columnsSettings.current[columnIndex] = columnSettings;
  }, []);
  var componentRendererColumns = (0, import_react.useRef)(/* @__PURE__ */ new Map());
  var renderedCellCache = (0, import_react.useRef)(/* @__PURE__ */ new Map());
  var clearRenderedCellCache = (0, import_react.useCallback)(function() {
    return renderedCellCache.current.clear();
  }, []);
  var portalCache = (0, import_react.useRef)(/* @__PURE__ */ new Map());
  var clearPortalCache = (0, import_react.useCallback)(function() {
    return portalCache.current.clear();
  }, []);
  var portalContainerCache = (0, import_react.useRef)(/* @__PURE__ */ new Map());
  var getRendererWrapper = (0, import_react.useCallback)(function(Renderer) {
    return function __internalRenderer(instance, TD, row, col, prop, value, cellProperties) {
      ...
      if (TD && !TD.getAttribute("ghost-table")) {
        ...
        if (cachedPortal && cachedPortalContainer) {
          ...
          var rendererElement = import_react.default.createElement(Renderer, {
            instance,
            TD,
            row,
            col,
          ...
          var _createPortal = createPortal(rendererElement, TD.ownerDocument, portalKey, cachedPortalContainer), portal = _createPortal.portal, portalContainer = _createPortal.portalContainer;
  ...
  var renderersPortalManager = (0, import_react.useRef)(function() {
    return void 0;
  });
  var setRenderersPortalManagerRef = (0, import_react.useCallback)(function(pmComponent) {
    renderersPortalManager.current = pmComponent;
  }, []);
  var pushCellPortalsIntoPortalManager = (0, import_react.useCallback)(function() {
    renderersPortalManager.current(_toConsumableArray(portalCache.current.values()));
  }, []);
  var contextImpl = (0, import_react.useMemo)(function() {
    return {
  ...
  return import_react.default.createElement(HotTableContext.Provider, {
    value: contextImpl
  }, children);
};
function useHotTableContext() {
  return (0, import_react.useContext)(HotTableContext);
}
var HotColumnContext = (0, import_react.createContext)(void 0);
var HotColumnContextProvider = function HotColumnContextProvider2(_ref) {
  var columnIndex = _ref.columnIndex, getOwnerDocument = _ref.getOwnerDocument, children = _ref.children;
  var contextImpl = (0, import_react.useMemo)(function() {
    return {
      columnIndex,
      getOwnerDocument
  ...
  return import_react.default.createElement(HotColumnContext.Provider, {
    value: contextImpl
  }, children);
};
var useHotColumnContext = function useHotColumnContext2() {
  return (0, import_react.useContext)(HotColumnContext);
};
...
function makeEditorClass(hooksRef, instanceRef) {
  return (function(_Handsontable$editors) {
    function CustomEditor(hotInstance) {
      ...
      Object.getOwnPropertyNames(base_default.editors.BaseEditor.prototype).forEach(function(propName) {
        ...
        var baseMethod = base_default.editors.BaseEditor.prototype[propName];
        CustomEditor.prototype[propName] = (function() {
          ...
          if (!AbstractMethods.includes(propName)) {
            result = baseMethod.call.apply(baseMethod, [this].concat(args));
          }
...
var EditorContextProvider = function EditorContextProvider2(_ref) {
  var hooksRef = _ref.hooksRef, hotCustomEditorInstanceRef = _ref.hotCustomEditorInstanceRef, children = _ref.children;
...
function applyEditorPosition(el, editor, hot, td) {
  ...
  var applyTdRect = function applyTdRect2(rect2) {
    el.style.top = "".concat(pageY + rect2.top - 1, "px");
    el.style.width = "".concat(rect2.width + 1, "px");
    el.style.height = "".concat(rect2.height + 1, "px");
    if (isRtl) {
      el.style.right = "".concat(pageX + rect2.right, "px");
      el.style.left = "auto";
    } else {
      el.style.left = "".concat(pageX + rect2.left - 1, "px");
      el.style.right = "auto";
    }
  };
  if (position === "portal") {
...
function useHotEditor(overriddenHooks, deps) {
  var _useContext = (0, import_react.useContext)(EditorContext), hooksRef = _useContext.hooksRef, hotCustomEditorInstanceRef = _useContext.hotCustomEditorInstanceRef;
  var _useState = (0, import_react.useState)(0), _useState2 = _slicedToArray(_useState, 2), rerenderTrigger = _useState2[0], setRerenderTrigger = _useState2[1];
  var _useState3 = (0, import_react.useState)(), _useState4 = _slicedToArray(_useState3, 2), editorValue = _useState4[0], setEditorValue = _useState4[1];
  var deferredValue = (0, import_react.useDeferredValue)(editorValue);
  (0, import_react.useImperativeHandle)(hooksRef, function() {
...
function EditorComponent(_ref2) {
  var _onPrepare = _ref2.onPrepare, _onClose = _ref2.onClose, _onOpen = _ref2.onOpen, _onFocus = _ref2.onFocus, children = _ref2.children, _ref2$shortcutsGroup = _ref2.shortcutsGroup, shortcutsGroup = _ref2$shortcutsGroup === void 0 ? "custom-editor" : _ref2$shortcutsGroup, shortcuts = _ref2.shortcuts;
  var mainElementRef = (0, import_react.useRef)(null);
  var currentValue = (0, import_react.useRef)(void 0);
  var _useState5 = (0, import_react.useState)(), _useState6 = _slicedToArray(_useState5, 2), themeClassName = _useState6[0], setThemeClassName = _useState6[1];
  var _useContext2 = (0, import_react.useContext)(EditorContext), hotCustomEditorInstanceRef = _useContext2.hotCustomEditorInstanceRef;
  var registerShortcuts = (0, import_react.useCallback)(function() {
    ...
    if (shortcuts) {
      editorContext === null || editorContext === void 0 || editorContext.addShortcuts(
  ...
  var unRegisterShortcuts = (0, import_react.useCallback)(function() {
  ...
  var refreshDimensions = (0, import_react.useCallback)(function() {
  ...
  var unRegisterScrollHooks = (0, import_react.useCallback)(function() {
    var editor = hotCustomEditorInstanceRef.current;
  ...
  var registerScrollHooks = (0, import_react.useCallback)(function() {
    var editor = hotCustomEditorInstanceRef.current;
    var hot = editor === null || editor === void 0 ? void 0 : editor.hot;
  ...
  }), value = _useHotEditor.value, setValue = _useHotEditor.setValue, finishEditing = _useHotEditor.finishEditing, isOpen = _useHotEditor.isOpen, col = _useHotEditor.col, row = _useHotEditor.row;
  (0, import_react.useEffect)(function() {
    currentValue.current = value;
  }, [value]);
  var stopMousedownPropagation = function stopMousedownPropagation2(e) {
    e.stopPropagation();
  };
...
var HotColumn = function HotColumn2(props) {
  var _useHotTableContext = useHotTableContext(), componentRendererColumns = _useHotTableContext.componentRendererColumns, emitColumnSettings = _useHotTableContext.emitColumnSettings, getRendererWrapper = _useHotTableContext.getRendererWrapper;
  var _useHotColumnContext = useHotColumnContext(), columnIndex = _useHotColumnContext.columnIndex, getOwnerDocument = _useHotColumnContext.getOwnerDocument;
  var localEditorHooksRef = (0, import_react.useRef)(null);
  var localEditorClassInstance = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(function() {
    var getSettingsProps = function getSettingsProps2() {
    ...
    var createColumnSettings = function createColumnSettings2() {
      var columnSettings2 = SettingsMapper.getSettings(getSettingsProps());
      if (props.renderer) {
        columnSettings2.renderer = getRendererWrapper(props.renderer);
        componentRendererColumns.set(columnIndex, true);
      } else if (props.hotRenderer) {
        columnSettings2.renderer = props.hotRenderer;
      }
      if (props.editor) {
        columnSettings2.editor = makeEditorClass(localEditorHooksRef, localEditorClassInstance);
      } else if (props.hotEditor) {
        columnSettings2.editor = props.hotEditor;
      }
  ...
  return import_react.default.createElement(EditorContextProvider, {
    hooksRef: localEditorHooksRef,
    hotCustomEditorInstanceRef: localEditorClassInstance
  }, editorPortal);
};
var version = "17.0.1";
var RenderersPortalManager = (0, import_react.forwardRef)(function(_, ref) {
  var _useState = (0, import_react.useState)([]), _useState2 = _slicedToArray(_useState, 2), portals = _useState2[0], setPortals = _useState2[1];
  (0, import_react.useImperativeHandle)(ref, function() {
    return setPortals;
  });
  return import_react.default.createElement(import_react.Fragment, null, portals);
});
...
var HotTableInner = (0, import_react.forwardRef)(function(props, ref) {
  var __hotInstance = (0, import_react.useRef)(null);
  var hotElementRef = (0, import_react.useRef)(null);
  var globalEditorHooksRef = (0, import_react.useRef)(null);
  var globalEditorClassInstance = (0, import_react.useRef)(null);
  var prevProps = (0, import_react.useRef)();
  var context = useHotTableContext();
  var getHotInstance = (0, import_react.useCallback)(function() {
  ...
  var isHotInstanceDestroyed = (0, import_react.useCallback)(function() {
    return !__hotInstance.current || __hotInstance.current.isDestroyed;
  }, [__hotInstance]);
  var clearCache = (0, import_react.useCallback)(function() {
    context.clearRenderedCellCache();
    context.componentRendererColumns.clear();
  }, [context]);
  var getOwnerDocument = (0, import_react.useCallback)(function() {
    if (isCSR()) {
      return hotElementRef.current ? hotElementRef.current.ownerDocument : document;
    }
    return null;
  }, [hotElementRef]);
  var createNewGlobalSettings = function createNewGlobalSettings2() {
    var _getHotInstance;
    var init = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
    var prevProps2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    ...
    if (props.renderer) {
      ...
      newSettings.renderer = props.hotRenderer || _getItem2("text");
    }
    if (props.editor) {
      newSettings.editor = makeEditorClass(globalEditorHooksRef, globalEditorClassInstance);
    } else {
      newSettings.editor = props.hotEditor || _getItem("text");
    }
    return newSettings;
  };
  var displayAutoSizeWarning = function displayAutoSizeWarning2(hotInstance) {
  ...
  (0, import_react.useEffect)(function() {
    ...
    __hotInstance.current = new base_default.Core(hotElementRef.current, newGlobalSettings);
  ...
  var hotColumnWrapped = import_react.Children.toArray(props.children).filter(isHotColumn).map(function(childNode, columnIndex) {
    return import_react.default.createElement(HotColumnContextProvider, {
      columnIndex,
      getOwnerDocument,
      key: columnIndex
    }, childNode);
  ...
  var editorPortal = createEditorPortal(getOwnerDocument(), props.editor);
  return import_react.default.createElement(import_react.Fragment, null, import_react.default.createElement("div", Object.assign({
    ref: hotElementRef
  }, containerProps), hotColumnWrapped), import_react.default.createElement(RenderersPortalManager, {
    ref: context.setRenderersPortalManagerRef
  }), import_react.default.createElement(EditorContextProvider, {
...
var HotTable = (0, import_react.forwardRef)(function(_ref, ref) {
  var _props$id;
  var children = _ref.children, props = _objectWithoutProperties(_ref, _excluded);
  var componentId = (_props$id = props.id) !== null && _props$id !== void 0 ? _props$id : (0, import_react.useId)();
  return import_react.default.createElement(HotTableContextProvider, null, import_react.default.createElement(HotTableInner, Object.assign({
    id: componentId
  }, props, {
    ref
  }), children));
...
@handsontable/react-wrapper/es/react-handsontable.mjs:
  (*
  object-assign
  (c) Sindre Sorhus
  @license MIT
  *)
*/
//# sourceMappingURL=@handsontable_react-wrapper.js.map
