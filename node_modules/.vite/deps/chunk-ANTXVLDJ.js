...
function getIntersectionOfArrays() {
  ...
  const isMatch = comparator ? (value, array) => array.some((item) => comparator(value, item)) : (value, array) => array.includes(value);
  const [first, ...rest] = arrays;
  let filteredFirstArray = first;
  arrayEach(rest, (array) => {
...
function html2(strings) {
  ...
  template.innerHTML = strings.reduce((acc, string, i) => {
    var _values$i;
    return acc + string + ((_values$i = values[i]) !== null && _values$i !== void 0 ? _values$i : "");
  }, "");
...
function _injectProductInfo(key, element, releaseDate) {
  ...
  if (isNonCommercial) {
    ...
    if (schemaValidity) {
      ...
      const releaseDays = Math.floor(Date.UTC(yyyy, mm - 1, dd) / 864e5);
      ...
      keyValidityDate = new Intl.DateTimeFormat("en-US", {
        ...
        day: "2-digit",
        timeZone: "UTC"
      }).format((keyValidityDays + 1) * 864e5);
...
function logAggregatedItems() {
  ...
  const affectedLines = ["Affected cells:", ...formattedItems, ...more ? [more] : []].join("\n");
...
// node_modules/handsontable/helpers/errors.mjs
...
function createUniqueSet() {
  ...
  function addItem(item) {
    if (uniqueSet.has(item)) {
      throwWithCause(errorItemExists(item));
    }
    uniqueSet.add(item);
  }
  function getItems() {
...
var FullyVisibleColumnsCalculationType = class {
  constructor() {
    ...
    _defineProperty4(this, "startColumn", null);
    _defineProperty4(this, "endColumn", null);
...
var FullyVisibleRowsCalculationType = class {
  constructor() {
    ...
    _defineProperty5(this, "startRow", null);
    _defineProperty5(this, "endRow", null);
...
var RenderedAllColumnsCalculationType = class {
  constructor() {
    ...
    _defineProperty8(this, "startColumn", 0);
    _defineProperty8(this, "endColumn", 0);
    _defineProperty8(this, "startPosition", 0);
    _defineProperty8(this, "isVisibleInTrimmingContainer", true);
  }
  /**
   * Initializes the calculation.
   *
...
var RenderedAllRowsCalculationType = class {
  constructor() {
    ...
    _defineProperty9(this, "startRow", 0);
    _defineProperty9(this, "endRow", 0);
...
var RenderedColumnsCalculationType = class extends PartiallyVisibleColumnsCalculationType {
  constructor() {
    super(...arguments);
    _defineProperty10(this, "columnStartOffset", 0);
    _defineProperty10(this, "columnEndOffset", 0);
  }
  /**
   * Finalizes the calculation.
   *
...
var RenderedRowsCalculationType = class extends PartiallyVisibleRowsCalculationType {
  constructor() {
    super(...arguments);
    _defineProperty11(this, "rowStartOffset", 0);
    _defineProperty11(this, "rowEndOffset", 0);
  }
  /**
   * Finalizes the calculation.
   *
...
var ViewportBaseCalculator = class {
  constructor(calculationTypes) {
    _defineProperty12(this, "calculationTypes", []);
    _defineProperty12(this, "calculationResults", /* @__PURE__ */ new Map());
...
var ViewportColumnsCalculator = class extends ViewportBaseCalculator {
  ...
  constructor(_ref) {
    ...
    _defineProperty13(this, "viewportWidth", 0);
    _defineProperty13(this, "scrollOffset", 0);
    _defineProperty13(this, "zeroBasedScrollOffset", 0);
    _defineProperty13(this, "totalColumns", 0);
    _defineProperty13(this, "columnWidthFn", null);
    _defineProperty13(this, "columnWidth", 0);
    _defineProperty13(this, "overrideFn", null);
    _defineProperty13(this, "inlineStartOffset", 0);
    _defineProperty13(this, "totalCalculatedWidth", 0);
    _defineProperty13(this, "startPositions", []);
    _defineProperty13(this, "needReverse", true);
...
var ViewportRowsCalculator = class extends ViewportBaseCalculator {
  ...
  constructor(_ref) {
    ...
    super(calculationTypes);
    _defineProperty14(this, "viewportHeight", 0);
    _defineProperty14(this, "scrollOffset", 0);
    _defineProperty14(this, "zeroBasedScrollOffset", 0);
    _defineProperty14(this, "totalRows", 0);
    _defineProperty14(this, "rowHeightFn", null);
    _defineProperty14(this, "rowHeight", 0);
    _defineProperty14(this, "overrideFn", null);
    _defineProperty14(this, "horizontalScrollbarHeight", 0);
    _defineProperty14(this, "innerViewportHeight", 0);
    _defineProperty14(this, "totalCalculatedHeight", 0);
...
var A11Y_GRIDCELL_BUTTON = () => ["role", "gridcell button"];
...
var A11Y_DIALOG = () => ["role", "dialog"];
var A11Y_ALERTDIALOG = () => ["role", "alertdialog"];
var A11Y_GROUP = () => ["role", "group"];
var A11Y_SCOPE_COL = () => ["scope", "col"];
var A11Y_SCOPE_ROW = () => ["scope", "row"];
var A11Y_TEXT = () => ["type", "text"];
var A11Y_LABEL = (val) => ["aria-label", val];
var A11Y_LABELED_BY = (val) => ["aria-labelledby", val];
var A11Y_DESCRIBED_BY = (val) => ["aria-describedby", val];
var A11Y_HIDDEN = () => ["aria-hidden", "true"];
var A11Y_DISABLED = function() {
...
var A11Y_MODAL = () => ["aria-modal", "true"];
...
function assignObjectDefaults(target, defaults) {
  ...
  Object.keys(defaults).forEach((key) => {
    if (typeof defaults[key] === "object" && defaults[key] !== null && !Array.isArray(defaults[key])) {
      ...
      result[key] = hasOwnProperty(target, key) && target[key] !== void 0 ? target[key] : defaults[key];
    }
  });
...
function filterRegexes(list, returnBoth) {
  ...
  regexFree.push(...list.filter((entry) => {
    const isRegex2 = entry instanceof RegExp;
    if (isRegex2 && returnBoth) {
      regexes.push(entry);
    }
    return !isRegex2;
  }));
...
var HTML_CHARACTERS = /(<(.*)>|&(.*);)/;
var dompurifyDeprecatedMessageShown = false;
function fastInnerHTML(element, content) {
  let sanitizer = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : sanitize;
...
function walkontableCalculateScrollbarWidth() {
  ...
  const calculateScrollbarWidth = function() {
    let shouldForceWebkitScrollbarStyles = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
...
var ColumnFilter = class {
  ...
  constructor(offset2, total, countTH) {
    _defineProperty15(this, "offset", void 0);
    _defineProperty15(this, "total", void 0);
    _defineProperty15(this, "countTH", void 0);
    this.offset = offset2;
    this.total = total;
...
var ViewSize = class {
  constructor() {
    _defineProperty17(this, "currentSize", 0);
    _defineProperty17(this, "nextSize", 0);
    _defineProperty17(this, "currentOffset", 0);
    _defineProperty17(this, "nextOffset", 0);
  }
  /**
...
var ViewSizeSet = class {
  constructor() {
    _defineProperty18(this, "size", new ViewSize());
    _defineProperty18(this, "workingSpace", WORKING_SPACE_ALL);
    _defineProperty18(this, "sharedSize", null);
  }
  /**
...
var ViewDiffer = class {
  constructor(sizeSet) {
    _defineProperty20(this, "sizeSet", void 0);
...
// node_modules/handsontable/3rdparty/walkontable/src/utils/orderView/rendererAdapter/differBasedRendererAdapter.mjs
...
var DifferBasedRendererAdapter = class {
   ...
   */
  applyCommand(command43) {
    const {
      rootNode
    } = this.orderView;
    const [name, nodeIndex, nodePrevIndex, nodeIndexToRemove] = command43;
...
// node_modules/handsontable/3rdparty/walkontable/src/utils/orderView/rendererAdapter/directDomRendererAdapter.mjs
...
var DirectDomRendererAdapter = class {
  /**
   * @param {OrderView} orderView The OrderView instance.
   */
  constructor(orderView) {
    _defineProperty22(this, "visualIndex", 0);
    this.orderView = orderView;
  }
  /**
...
// node_modules/handsontable/3rdparty/walkontable/src/utils/orderView/rendererAdapter/index.mjs
...
var OrderView = class {
  constructor(rootNode, nodesPool, childNodeType) {
    _defineProperty23(this, "rootNode", void 0);
    _defineProperty23(this, "nodesPool", void 0);
    _defineProperty23(this, "sizeSet", new ViewSizeSet());
    _defineProperty23(this, "collectedNodes", []);
    _defineProperty23(this, "viewDiffer", new ViewDiffer(this.sizeSet));
    _defineProperty23(this, "childNodeType", void 0);
    _defineProperty23(this, "rendererAdapter", void 0);
...
var NodesPool = class {
  constructor(nodeType) {
    ...
    _defineProperty24(this, "pool", /* @__PURE__ */ new Map());
...
var BaseRenderer = class {
  constructor(nodeType, rootNode) {
    _defineProperty25(this, "nodesPool", null);
    _defineProperty25(this, "nodeType", void 0);
    _defineProperty25(this, "rootNode", void 0);
    _defineProperty25(this, "table", null);
    _defineProperty25(this, "renderedNodes", 0);
...
var RowHeadersRenderer = class extends BaseRenderer {
  constructor() {
    super("TH");
    _defineProperty26(this, "orderViews", /* @__PURE__ */ new WeakMap());
    _defineProperty26(this, "sourceRowIndex", 0);
  }
  /**
...
var RowsRenderer = class extends BaseRenderer {
  constructor(rootNode) {
    super("TR", rootNode);
    _defineProperty27(this, "orderView", void 0);
...
var CellsRenderer = class extends BaseRenderer {
  constructor() {
    super("TD");
    _defineProperty28(this, "orderViews", /* @__PURE__ */ new WeakMap());
    _defineProperty28(this, "sourceRowIndex", 0);
  }
  /**
   * Obtains the instance of the SharedOrderView class which is responsible for rendering the nodes to the root node.
   *
...
var TableRenderer = class {
  constructor(rootNode) {
    ...
    _defineProperty29(this, "rootNode", void 0);
    _defineProperty29(this, "rootDocument", void 0);
    _defineProperty29(this, "rowHeaders", null);
    _defineProperty29(this, "columnHeaders", null);
    _defineProperty29(this, "colGroup", null);
    _defineProperty29(this, "rows", null);
    _defineProperty29(this, "cells", null);
    _defineProperty29(this, "rowFilter", null);
    _defineProperty29(this, "columnFilter", null);
    _defineProperty29(this, "rowUtils", null);
    _defineProperty29(this, "columnUtils", null);
    _defineProperty29(this, "rowsToRender", 0);
    _defineProperty29(this, "columnsToRender", 0);
    _defineProperty29(this, "rowHeaderFunctions", []);
    _defineProperty29(this, "rowHeadersCount", 0);
    _defineProperty29(this, "columnHeaderFunctions", []);
    _defineProperty29(this, "columnHeadersCount", 0);
    _defineProperty29(this, "cellRenderer", void 0);
    _defineProperty29(this, "activeOverlayName", void 0);
    _defineProperty29(this, "stylesHandler", void 0);
    this.rootNode = rootNode;
...
var ColumnUtils = class {
  ...
  constructor(dataAccessObject, wtSettings) {
    ...
    _defineProperty30(this, "headerWidths", /* @__PURE__ */ new Map());
...
var RowUtils = class {
   ...
   */
  constructor(dataAccessObject, wtSettings) {
    _defineProperty31(this, "dataAccessObject", void 0);
    _defineProperty31(this, "wtSettings", void 0);
    this.dataAccessObject = dataAccessObject;
    this.wtSettings = wtSettings;
  }
  /**
...
var Table = class {
  ...
  constructor(dataAccessObject, facadeGetter, domBindings, wtSettings, name) {
    _defineProperty32(this, "wtSettings", null);
    _defineProperty32(this, "domBindings", void 0);
    _defineProperty32(this, "TBODY", null);
    _defineProperty32(this, "THEAD", null);
    _defineProperty32(this, "COLGROUP", null);
    _defineProperty32(this, "hasTableHeight", true);
    _defineProperty32(this, "hasTableWidth", true);
    _defineProperty32(this, "isTableVisible", false);
    _defineProperty32(this, "tableOffset", 0);
    _defineProperty32(this, "holderOffset", 0);
...
var EventManager = class {
  ...
  constructor() {
    let context = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null;
    _defineProperty33(this, "context", void 0);
...
var Scroll = class {
  ...
  constructor(dataAccessObject) {
    ...
    _defineProperty34(this, "dataAccessObject", void 0);
    this.dataAccessObject = dataAccessObject;
  }
  /**
...
var CoreAbstract = class {
  ...
  constructor(table, settings) {
    _defineProperty35(this, "wtTable", void 0);
    _defineProperty35(this, "wtScroll", void 0);
    _defineProperty35(this, "wtViewport", void 0);
    _defineProperty35(this, "wtOverlays", void 0);
    _defineProperty35(this, "selectionManager", void 0);
    _defineProperty35(this, "wtEvent", void 0);
    _defineProperty35(this, "guid", `wt_${randomString()}`);
    _defineProperty35(this, "drawInterrupted", false);
    _defineProperty35(this, "drawn", false);
    _defineProperty35(this, "activeOverlayName", "master");
    _defineProperty35(this, "domBindings", void 0);
...
var Clone = class extends CoreAbstract {
  ...
  constructor(table, settings, clone3) {
    ...
    _defineProperty36(this, "cloneSource", void 0);
    _defineProperty36(this, "cloneOverlay", void 0);
...
var Overlay = class {
  ...
  updateMainScrollableElement() {
    ...
    const computedOverflow = rootWindow.getComputedStyle(wtTable.wtRootElement.parentNode).getPropertyValue("overflow");
...
var BottomOverlay = class extends Overlay {
  ...
  constructor(wotInstance, facadeGetter, wtSettings, domBindings) {
    ...
    _defineProperty38(this, "cachedFixedRowsBottom", -1);
...
var localHooks = {
  ...
  removeLocalHook(key, callback) {
    if (this._localHooks[key]) {
      const index2 = this._localHooks[key].indexOf(callback);
      if (index2 > -1) {
        this._localHooks[key].splice(index2, 1);
      }
    }
    return this;
  },
...
var BORDER_STYLE_CLASS_PREFIX = "ht-border-style-";
var BORDER_STYLE_VERTICAL_SUFFIX = "-vertical";
var BORDER_STYLE_HORIZONTAL_SUFFIX = "-horizontal";
var Border = class {
  ...
  appear(corners) {
    ...
    this.bottomStyle.top = `${top2 + height - parseInt(this.bottomStyle.height, 10) + delta}px`;
...
var SelectionManager = class {
  ...
  refreshAllBorderHandleStyles() {
    _classPrivateFieldGet6(_selectionBorders, this).forEach((bordersMap) => {
...
var TopInlineStartCornerOverlay = class extends Overlay {
  ...
  constructor(wotInstance, facadeGetter, wtSettings, domBindings, topOverlay, inlineStartOverlay) {
    ...
    _defineProperty39(this, "topOverlay", void 0);
    _defineProperty39(this, "inlineStartOverlay", void 0);
...
var TopOverlay = class extends Overlay {
  ...
  constructor(wotInstance, facadeGetter, wtSettings, domBindings) {
    ...
    _defineProperty40(this, "cachedFixedRowsTop", -1);
...
var Overlays = class {
  ...
  constructor(wotInstance, facadeGetter, domBindings, wtSettings, eventManager, wtTable) {
    _defineProperty41(this, "wot", null);
    _classPrivateFieldInitSpec7(this, _overlays, []);
    _defineProperty41(this, "topOverlay", null);
    _defineProperty41(this, "bottomOverlay", null);
    _defineProperty41(this, "inlineStartOverlay", null);
    _defineProperty41(this, "topInlineStartCornerOverlay", null);
    _defineProperty41(this, "bottomInlineStartCornerOverlay", null);
    _defineProperty41(this, "browserLineHeight", void 0);
    ...
    _defineProperty41(this, "resizeObserver", new ResizeObserver((entries2) => {
      requestAnimationFrame(() => {
        ...
        if (_classPrivateFieldGet7(_containerDomResizeCount, this) === 300) {
...
var Settings = class {
  ...
  constructor(settings) {
    _defineProperty42(this, "settings", {});
    _defineProperty42(this, "defaults", Object.freeze(this.getDefaults()));
...
var BaseEditor = class {
  ...
  constructor(hotInstance) {
    ...
    _defineProperty43(this, "state", EDITOR_STATE.VIRGIN);
    _defineProperty43(this, "_opened", false);
    _defineProperty43(this, "_fullEditMode", false);
    _defineProperty43(this, "_closeCallback", null);
    _defineProperty43(this, "_closeAfterDataChange", true);
    _defineProperty43(this, "TD", null);
    _defineProperty43(this, "row", null);
    _defineProperty43(this, "col", null);
    _defineProperty43(this, "prop", null);
    _defineProperty43(this, "originalValue", null);
    _defineProperty43(this, "cellProperties", null);
...
var TEXT_ELLIPSIS_CLASS_NAME = "htTextEllipsis";
...
var TextEditor = class extends BaseEditor {
  ...
  constructor(hotInstance) {
    super(hotInstance);
    _defineProperty44(this, "eventManager", new eventManager_default(this));
    _defineProperty44(this, "autoResize", createInputElementResizer(this.hot.rootDocument));
    _defineProperty44(this, "TEXTAREA", void 0);
    _defineProperty44(this, "textareaStyle", void 0);
    _defineProperty44(this, "TEXTAREA_PARENT", void 0);
    _defineProperty44(this, "textareaParentStyle", void 0);
    _defineProperty44(this, "layerClass", void 0);
   ...
   */
  createElements() {
    let type = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "textarea";
    const {
      rootDocument
    } = this.hot;
...
var TD_OPEN = /<td\b[^>]*>/i;
var TD_CLOSE = /<\/\s*td\s*>/i;
var paragraphRegexp = /<p.*?>/g;
function findMatchingTdClose(html3, openEndIndex) {
  let depth = 1;
  let searchStart = openEndIndex;
  while (depth > 0) {
    const tail = html3.substring(searchStart);
    ...
    const openIndex = openMatch ? searchStart + openMatch.index : html3.length;
...
function replaceTdCellsWithTextContent(html3) {
  const result = [];
  let pos = 0;
  while (pos < html3.length) {
    const openMatch = html3.substring(pos).match(TD_OPEN);
    if (!openMatch) {
      result.push(html3.substring(pos));
      break;
    }
    const openStart = pos + openMatch.index;
    const openTag = openMatch[0];
    const openEnd = openStart + openTag.length;
    result.push(html3.substring(pos, openStart));
    const closeInfo = findMatchingTdClose(html3, openEnd);
    if (!closeInfo) {
      result.push(html3.substring(openStart));
      break;
    }
    const cellFragment = html3.substring(openStart, closeInfo.start + closeInfo.length);
    const contentEnd = closeInfo.start - openStart;
    const rawContent = cellFragment.substring(openTag.length, contentEnd).trim().replaceAll(/\n\s+/g, " ").replaceAll(paragraphRegexp, "\n").replace(/^\n+/, "").replaceAll(/<\/(.*)>\s+$/mg, "</$1>").replace(/(<(?!br)([^>]+)>)/gi, "").replaceAll(/^&nbsp;$/mg, "");
...
var IndexMap = class {
  constructor() {
    ...
    _defineProperty45(this, "indexedValues", []);
    _defineProperty45(this, "initValueOrFn", void 0);
...
var LinkedPhysicalIndexToValueMap = class extends IndexMap {
  constructor() {
    super(...arguments);
    _defineProperty46(this, "orderOfIndexes", []);
  }
  /**
...
var MapCollection = class {
  constructor() {
    _defineProperty47(this, "collection", /* @__PURE__ */ new Map());
  }
  /**
...
var AggregatedCollection = class extends MapCollection {
  constructor(aggregationFunction, fallbackValue) {
    super();
    _defineProperty48(this, "mergedValuesCache", []);
    _defineProperty48(this, "aggregationFunction", void 0);
    _defineProperty48(this, "fallbackValue", void 0);
...
var ChangesObserver = class {
  ...
  subscribe(callback) {
    ...
    this._write(_classPrivateFieldGet8(_currentInitialChanges, this));
    return this;
  }
  /**
  ...
  _writeInitialChanges(initialChanges) {
    _classPrivateFieldSet8(_currentInitialChanges, this, initialChanges);
  }
};
...
var ChangesObservable = class {
  constructor() {
    ...
    _classPrivateFieldInitSpec9(this, _observers, /* @__PURE__ */ new Set());
    _classPrivateFieldInitSpec9(this, _indexMatrix, []);
    _classPrivateFieldInitSpec9(this, _currentIndexState, []);
    _classPrivateFieldInitSpec9(this, _isMatrixIndexesInitialized, false);
    _classPrivateFieldInitSpec9(this, _initialIndexValue, false);
    _classPrivateFieldSet9(_initialIndexValue, this, initialIndexValue !== null && initialIndexValue !== void 0 ? initialIndexValue : false);
  }
  /* eslint-disable jsdoc/require-description-complete-sentence */
  /**
  ...
  createObserver() {
    ...
    _classPrivateFieldGet9(_observers, this).add(observer);
    observer.addLocalHook("unsubscribe", () => {
      _classPrivateFieldGet9(_observers, this).delete(observer);
    });
    observer._writeInitialChanges(arrayDiff(_classPrivateFieldGet9(_indexMatrix, this), _classPrivateFieldGet9(_currentIndexState, this)));
    return observer;
  }
  /**
   ...
   */
  emit(indexesState) {
    let currentIndexState = _classPrivateFieldGet9(_currentIndexState, this);
    if (!_classPrivateFieldGet9(_isMatrixIndexesInitialized, this) || _classPrivateFieldGet9(_indexMatrix, this).length !== indexesState.length) {
      if (indexesState.length === 0) {
        indexesState = new Array(currentIndexState.length).fill(_classPrivateFieldGet9(_initialIndexValue, this));
      } else {
        _classPrivateFieldSet9(_indexMatrix, this, new Array(indexesState.length).fill(_classPrivateFieldGet9(_initialIndexValue, this)));
      }
      if (!_classPrivateFieldGet9(_isMatrixIndexesInitialized, this)) {
        _classPrivateFieldSet9(_isMatrixIndexesInitialized, this, true);
        currentIndexState = _classPrivateFieldGet9(_indexMatrix, this);
      }
    }
    const changes = arrayDiff(currentIndexState, indexesState);
    _classPrivateFieldGet9(_observers, this).forEach((observer) => observer._write(changes));
    _classPrivateFieldSet9(_currentIndexState, this, indexesState);
  }
};
...
var IndexMapper = class {
  constructor() {
    _defineProperty49(this, "indexesSequence", new IndexesSequence());
    _defineProperty49(this, "trimmingMapsCollection", new AggregatedCollection((valuesForIndex) => valuesForIndex.some((value) => value === true), false));
    _defineProperty49(this, "hidingMapsCollection", new AggregatedCollection((valuesForIndex) => valuesForIndex.some((value) => value === true), false));
    _defineProperty49(this, "variousMapsCollection", new MapCollection());
    _defineProperty49(this, "hidingChangesObservable", new ChangesObservable({
      initialIndexValue: false
    }));
    _defineProperty49(this, "notTrimmedIndexesCache", []);
    _defineProperty49(this, "notHiddenIndexesCache", []);
    _defineProperty49(this, "isBatched", false);
    _defineProperty49(this, "indexesSequenceChanged", false);
    _defineProperty49(this, "indexesChangeSource", void 0);
    _defineProperty49(this, "trimmedIndexesChanged", false);
    _defineProperty49(this, "hiddenIndexesChanged", false);
    _defineProperty49(this, "renderablePhysicalIndexesCache", []);
    _defineProperty49(this, "fromPhysicalToVisualIndexesCache", /* @__PURE__ */ new Map());
    _defineProperty49(this, "fromVisualToRenderableIndexesCache", /* @__PURE__ */ new Map());
  ...
  insertIndexes(firstInsertedVisualIndex, amountOfIndexes) {
    let mode = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "start";
    ...
    this.indexesChangeSource = void 0;
    const modInsertedIndexes = mode === "end" ? insertedIndexes.map((index2) => index2 + 1) : insertedIndexes;
...
__export(constants_exports, {
  ...
  EMPTY_DATA_STATE_BUTTONS_FILTERS_RESET: () => EMPTY_DATA_STATE_BUTTONS_FILTERS_RESET,
  EMPTY_DATA_STATE_DESCRIPTION: () => EMPTY_DATA_STATE_DESCRIPTION,
  EMPTY_DATA_STATE_DESCRIPTION_FILTERS: () => EMPTY_DATA_STATE_DESCRIPTION_FILTERS,
  EMPTY_DATA_STATE_NAMESPACE: () => EMPTY_DATA_STATE_NAMESPACE,
  EMPTY_DATA_STATE_TITLE: () => EMPTY_DATA_STATE_TITLE,
  EMPTY_DATA_STATE_TITLE_FILTERS: () => EMPTY_DATA_STATE_TITLE_FILTERS,
  ...
  LOADING_NAMESPACE: () => LOADING_NAMESPACE,
  LOADING_TITLE: () => LOADING_TITLE,
  OK: () => OK,
  PAGINATION_COUNTER_SECTION: () => PAGINATION_COUNTER_SECTION,
  PAGINATION_FIRST_PAGE: () => PAGINATION_FIRST_PAGE,
  PAGINATION_LAST_PAGE: () => PAGINATION_LAST_PAGE,
  PAGINATION_NAMESPACE: () => PAGINATION_NAMESPACE,
  PAGINATION_NAV_SECTION: () => PAGINATION_NAV_SECTION,
  PAGINATION_NEXT_PAGE: () => PAGINATION_NEXT_PAGE,
  PAGINATION_PAGE_SIZE_AUTO: () => PAGINATION_PAGE_SIZE_AUTO,
  PAGINATION_PAGE_SIZE_SECTION: () => PAGINATION_PAGE_SIZE_SECTION,
  PAGINATION_PREV_PAGE: () => PAGINATION_PREV_PAGE,
  PAGINATION_SECTION: () => PAGINATION_SECTION
});
var COMMON_NAMESPACE = "Common:";
var OK = `${COMMON_NAMESPACE}ok`;
var CANCEL = `${COMMON_NAMESPACE}cancel`;
...
var PAGINATION_NAMESPACE = "Pagination:";
var PAGINATION_SECTION = `${PAGINATION_NAMESPACE}section.pagination`;
var PAGINATION_PAGE_SIZE_AUTO = `${PAGINATION_NAMESPACE}.pageSize.auto`;
var PAGINATION_PAGE_SIZE_SECTION = `${PAGINATION_NAMESPACE}section.pageSize`;
var PAGINATION_COUNTER_SECTION = `${PAGINATION_NAMESPACE}section.counter`;
var PAGINATION_NAV_SECTION = `${PAGINATION_NAMESPACE}section.navigation`;
var PAGINATION_FIRST_PAGE = `${PAGINATION_NAMESPACE}firstPage`;
var PAGINATION_PREV_PAGE = `${PAGINATION_NAMESPACE}prevPage`;
var PAGINATION_NEXT_PAGE = `${PAGINATION_NAMESPACE}nextPage`;
var PAGINATION_LAST_PAGE = `${PAGINATION_NAMESPACE}lastPage`;
...
var LOADING_NAMESPACE = "Loading:";
var LOADING_TITLE = `${LOADING_NAMESPACE}title`;
var EMPTY_DATA_STATE_NAMESPACE = "EmptyDataState:";
var EMPTY_DATA_STATE_TITLE = `${EMPTY_DATA_STATE_NAMESPACE}title`;
var EMPTY_DATA_STATE_DESCRIPTION = `${EMPTY_DATA_STATE_NAMESPACE}description`;
var EMPTY_DATA_STATE_TITLE_FILTERS = `${EMPTY_DATA_STATE_NAMESPACE}title.filters`;
var EMPTY_DATA_STATE_DESCRIPTION_FILTERS = `${EMPTY_DATA_STATE_NAMESPACE}description.filters`;
var EMPTY_DATA_STATE_BUTTONS_FILTERS_RESET = `${EMPTY_DATA_STATE_NAMESPACE}buttons.filters.reset`;
...
var VisualSelection = class extends selection_default {
  constructor(settings, visualCellRange) {
    super(settings, null);
    _defineProperty50(this, "visualCellRange", null);
...
var Highlight = class {
  constructor(options) {
    _classPrivateMethodInitSpec5(this, _Highlight_brand);
    _defineProperty51(this, "options", void 0);
    _defineProperty51(this, "layerLevel", 0);
    _defineProperty51(this, "focus", void 0);
    _defineProperty51(this, "fill", void 0);
    _defineProperty51(this, "layeredAreas", /* @__PURE__ */ new Map());
    _defineProperty51(this, "areas", /* @__PURE__ */ new Map());
    _defineProperty51(this, "rowHeaders", /* @__PURE__ */ new Map());
    _defineProperty51(this, "columnHeaders", /* @__PURE__ */ new Map());
    _defineProperty51(this, "activeRowHeaders", /* @__PURE__ */ new Map());
    _defineProperty51(this, "activeColumnHeaders", /* @__PURE__ */ new Map());
    _defineProperty51(this, "activeCornerHeaders", /* @__PURE__ */ new Map());
    _defineProperty51(this, "rowHighlights", /* @__PURE__ */ new Map());
    _defineProperty51(this, "columnHighlights", /* @__PURE__ */ new Map());
    _defineProperty51(this, "customSelections", []);
   ...
   */
  createLayeredArea() {
    return _assertClassBrand11(_Highlight_brand, this, _createHighlight).call(this, this.layeredAreas, createHighlight2);
  }
  /**
   ...
   */
  createArea() {
    return _assertClassBrand11(_Highlight_brand, this, _createHighlight).call(this, this.areas, createHighlight3);
  }
  /**
   * Get all Walkontable Selection instances which describes the state of the visual highlight of the cells.
   *
   ...
   */
  createRowHeader() {
    return _assertClassBrand11(_Highlight_brand, this, _createHighlight).call(this, this.rowHeaders, createHighlight8);
  }
  /**
   ...
   */
  createColumnHeader() {
    return _assertClassBrand11(_Highlight_brand, this, _createHighlight).call(this, this.columnHeaders, createHighlight8);
  }
  /**
   * Get all Walkontable Selection instances which describes the state of the visual highlight of the headers.
   *
  ...
  createActiveRowHeader() {
    return _assertClassBrand11(_Highlight_brand, this, _createHighlight).call(this, this.activeRowHeaders, createHighlight);
  }
  /**
  ...
  createActiveColumnHeader() {
    return _assertClassBrand11(_Highlight_brand, this, _createHighlight).call(this, this.activeColumnHeaders, createHighlight);
  }
  /**
   * Get all Walkontable Selection instances which describes the state of the visual highlight of the active headers.
   *
  ...
  createActiveCornerHeader() {
    return _assertClassBrand11(_Highlight_brand, this, _createHighlight).call(this, this.activeCornerHeaders, createHighlight);
  }
  /**
   ...
   */
  createRowHighlight() {
    return _assertClassBrand11(_Highlight_brand, this, _createHighlight).call(this, this.rowHighlights, createHighlight9);
  }
  /**
  ...
  createColumnHighlight() {
    return _assertClassBrand11(_Highlight_brand, this, _createHighlight).call(this, this.columnHighlights, createHighlight4);
  }
  /**
...
var SelectionRange = class _SelectionRange {
  constructor(createCellRange) {
    _defineProperty52(this, "ranges", []);
    _defineProperty52(this, "createCellRange", void 0);
   ...
   */
  includes(coords) {
    let criteria = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : () => true;
    return this.ranges.some((cellRange, index2) => cellRange.includes(coords) && criteria(cellRange, index2));
  }
  /**
  ...
  removeLayers(layerIndexes) {
    this.ranges = this.ranges.filter((_, index2) => !layerIndexes.includes(index2));
    return this;
  }
  /**
   * Clear collection.
   ...
   */
  clone() {
    const clone3 = new _SelectionRange(this.createCellRange);
    clone3.ranges = this.ranges.map((cellRange) => cellRange.clone());
    return clone3;
  }
  /**
   ...
   */
  map(mapFunction) {
    this.ranges = this.ranges.map((cellRange, index2) => mapFunction(cellRange, index2));
    return this;
  }
  /**
...
// node_modules/handsontable/selection/transformation/_base.mjs
...
var BaseTransformation = class {
  constructor(range, tableApi) {
    _classPrivateMethodInitSpec6(this, _BaseTransformation_brand);
    _classPrivateFieldInitSpec10(this, _range, void 0);
    _classPrivateFieldInitSpec10(this, _activeLayerIndex, 0);
    _classPrivateFieldInitSpec10(this, _offset, {
      x: 0,
      y: 0
    });
    _defineProperty53(this, "tableApi", void 0);
    _classPrivateFieldSet10(_range, this, range);
  ...
  setActiveLayerIndex(layerIndex) {
    _classPrivateFieldSet10(_activeLayerIndex, this, layerIndex);
  }
  /**
   ...
   */
  getCurrentSelection() {
    return _classPrivateFieldGet10(_range, this).peekByIndex(_classPrivateFieldGet10(_activeLayerIndex, this));
  }
  /**
  ...
  transformStart(rowDelta, colDelta) {
    ...
    _classPrivateFieldSet10(_offset, this, this.calculateOffset());
    ...
    if (highlightRenderableCoords.row !== null && highlightRenderableCoords.col !== null) {
      let {
        width,
        height
      } = _assertClassBrand12(_BaseTransformation_brand, this, _getTableSize).call(this);
      const {
        row,
        col
      } = _assertClassBrand12(_BaseTransformation_brand, this, _visualToZeroBasedCoords).call(this, visualCoords);
      ...
      if (zeroBasedCoords.row >= height) {
        ...
        this.runLocalHooks("beforeColumnWrap", isActionInterrupted, _assertClassBrand12(_BaseTransformation_brand, this, _zeroBasedToVisualCoords).call(this, newCoords), isColumnOutOfRange);
        if (isActionInterrupted.value) {
          this.runLocalHooks("insertRowRequire", this.countRenderableRows());
        } else if (autoWrapCol) {
          if (this.shouldSwitchSelectionLayer() && isColumnOutOfRange && _classPrivateFieldGet10(_range, this).size() > 1) {
            _assertClassBrand12(_BaseTransformation_brand, this, _chooseNextSelectionLayer).call(this);
            const nextLayerCoords = _assertClassBrand12(_BaseTransformation_brand, this, _findNonHiddenZeroBasedCoordsInSelection).call(this, "forward");
        ...
        if (autoWrapCol) {
          if (this.shouldSwitchSelectionLayer() && isColumnOutOfRange && _classPrivateFieldGet10(_range, this).size() > 1) {
            _assertClassBrand12(_BaseTransformation_brand, this, _choosePreviousSelectionLayer).call(this);
            const nextLayerCoords = _assertClassBrand12(_BaseTransformation_brand, this, _findNonHiddenZeroBasedCoordsInSelection).call(this, "backward");
            if (nextLayerCoords !== null) {
              newCoords.assign(nextLayerCoords);
            }
          }
      ...
      if (zeroBasedCoords.col >= width) {
        ...
        this.runLocalHooks("beforeRowWrap", isActionInterrupted, _assertClassBrand12(_BaseTransformation_brand, this, _zeroBasedToVisualCoords).call(this, newCoords), isRowOutOfRange);
        if (isActionInterrupted.value) {
          this.runLocalHooks("insertColRequire", this.countRenderableColumns());
        } else if (autoWrapRow) {
          if (this.shouldSwitchSelectionLayer() && isRowOutOfRange && _classPrivateFieldGet10(_range, this).size() > 1) {
            _assertClassBrand12(_BaseTransformation_brand, this, _chooseNextSelectionLayer).call(this);
            const nextLayerCoords = _assertClassBrand12(_BaseTransformation_brand, this, _findNonHiddenZeroBasedCoordsInSelection).call(this, "forward");
            if (nextLayerCoords !== null) {
              newCoords.assign(nextLayerCoords);
      ...
      const {
        rowDir,
        colDir
      } = _assertClassBrand12(_BaseTransformation_brand, this, _clampCoords).call(this, zeroBasedCoords);
      rowTransformDir = rowDir;
      colTransformDir = colDir;
      visualCoords = _assertClassBrand12(_BaseTransformation_brand, this, _zeroBasedToVisualCoords).call(this, zeroBasedCoords);
    }
    this.runLocalHooks("afterTransformStart", visualCoords, rowTransformDir, colTransformDir);
    return {
      selectionLayer: _classPrivateFieldGet10(_activeLayerIndex, this),
      visualCoords
    };
  }
  /**
  ...
  transformEnd(rowDelta, colDelta) {
    ...
    const toRow = _assertClassBrand12(_BaseTransformation_brand, this, _findFirstNonHiddenZeroBasedRow).call(this, cellRange.to.row, cellRange.from.row);
    const toColumn = _assertClassBrand12(_BaseTransformation_brand, this, _findFirstNonHiddenZeroBasedColumn).call(this, cellRange.to.col, cellRange.from.col);
    ...
    if (highlightRenderableCoords.row !== null && highlightRenderableCoords.col !== null && toRow !== null && toColumn !== null) {
      const {
        row: highlightRow,
        col: highlightColumn
      } = _assertClassBrand12(_BaseTransformation_brand, this, _visualToZeroBasedCoords).call(this, cellRange.highlight);
      ...
      if (delta.col < 0 && toColumn >= highlightColumn && coords.col < highlightColumn) {
        ...
        coords.col = _assertClassBrand12(_BaseTransformation_brand, this, _findFirstNonHiddenZeroBasedColumn).call(this, topStartCorner.col, topEndCorner.col) + columnRestDelta;
      } else if (delta.col > 0 && toColumn <= highlightColumn && coords.col > highlightColumn) {
        const endColumnIndex = _assertClassBrand12(_BaseTransformation_brand, this, _findFirstNonHiddenZeroBasedColumn).call(this, topEndCorner.col, topStartCorner.col);
      ...
      if (delta.row < 0 && toRow >= highlightRow && coords.row < highlightRow) {
        ...
        coords.row = _assertClassBrand12(_BaseTransformation_brand, this, _findFirstNonHiddenZeroBasedRow).call(this, topStartCorner.row, bottomEndCorner.row) + rowRestDelta;
      } else if (delta.row > 0 && toRow <= highlightRow && coords.row > highlightRow) {
        const bottomRowIndex = _assertClassBrand12(_BaseTransformation_brand, this, _findFirstNonHiddenZeroBasedRow).call(this, bottomEndCorner.row, topStartCorner.row);
      ...
      const {
        rowDir,
        colDir
      } = _assertClassBrand12(_BaseTransformation_brand, this, _clampCoords).call(this, coords);
      rowTransformDir = rowDir;
      colTransformDir = colDir;
      const newVisualCoords = _assertClassBrand12(_BaseTransformation_brand, this, _zeroBasedToVisualCoords).call(this, coords);
...
function _chooseNextSelectionLayer() {
  const layerIndex = _classPrivateFieldGet10(_activeLayerIndex, this) + 1;
  this.setActiveLayerIndex(layerIndex >= _classPrivateFieldGet10(_range, this).size() ? 0 : layerIndex);
  _classPrivateFieldSet10(_offset, this, this.calculateOffset());
}
function _choosePreviousSelectionLayer() {
  const layerIndex = _classPrivateFieldGet10(_activeLayerIndex, this) - 1;
  this.setActiveLayerIndex(layerIndex < 0 ? _classPrivateFieldGet10(_range, this).size() - 1 : layerIndex);
  _classPrivateFieldSet10(_offset, this, this.calculateOffset());
}
...
function _getTableSize() {
  return {
    width: _classPrivateFieldGet10(_offset, this).x + this.countRenderableColumns(),
    height: _classPrivateFieldGet10(_offset, this).y + this.countRenderableRows()
  };
}
function _findNonHiddenZeroBasedCoordsInSelection(direction) {
  ...
  const zeroBasedRow = _assertClassBrand12(_BaseTransformation_brand, this, _findFirstNonHiddenZeroBasedRow).call(this, visualRowFrom, visualRowTo);
  const zeroBasedCol = _assertClassBrand12(_BaseTransformation_brand, this, _findFirstNonHiddenZeroBasedColumn).call(this, visualColumnFrom, visualColumnTo);
...
function _findFirstNonHiddenZeroBasedRow(visualRowFrom, visualRowTo) {
  ...
  return _classPrivateFieldGet10(_offset, this).y + row;
}
function _findFirstNonHiddenZeroBasedColumn(visualColumnFrom, visualColumnTo) {
  ...
  return _classPrivateFieldGet10(_offset, this).x + column;
}
function _visualToZeroBasedCoords(visualCoords) {
  ...
  return this.tableApi.createCellCoords(_classPrivateFieldGet10(_offset, this).y + row, _classPrivateFieldGet10(_offset, this).x + col);
}
function _zeroBasedToVisualCoords(zeroBasedCoords) {
  const coords = zeroBasedCoords.clone();
  coords.col = zeroBasedCoords.col - _classPrivateFieldGet10(_offset, this).x;
  coords.row = zeroBasedCoords.row - _classPrivateFieldGet10(_offset, this).y;
  return this.tableApi.renderableToVisualCoords(coords);
}
mixin(BaseTransformation, localHooks_default);

// node_modules/handsontable/selection/transformation/extender.mjs
var ExtenderTransformation = class extends BaseTransformation {
  /**
...
// node_modules/handsontable/selection/transformation/focus.mjs
var FocusTransformation = class extends BaseTransformation {
  /**
...
var Selection2 = class {
  constructor(settings, tableProps) {
    var _this = this;
    _defineProperty54(this, "settings", void 0);
    _defineProperty54(this, "tableProps", void 0);
    _defineProperty54(this, "inProgress", false);
    _defineProperty54(this, "selectedRange", new range_default2((highlight, from, to) => {
      return this.tableProps.createCellRange(highlight, from, to);
    }));
    _defineProperty54(this, "highlight", void 0);
    _classPrivateFieldInitSpec11(this, _extenderTransformation, void 0);
    _classPrivateFieldInitSpec11(this, _focusTransformation, void 0);
    _defineProperty54(this, "selectedByRowHeader", /* @__PURE__ */ new Set());
    _defineProperty54(this, "selectedByColumnHeader", /* @__PURE__ */ new Set());
    _classPrivateFieldInitSpec11(this, _isFocusSelectionChanged, false);
    _classPrivateFieldInitSpec11(this, _disableHeadersHighlight, false);
    _classPrivateFieldInitSpec11(this, _selectionSource, "unknown");
    _classPrivateFieldInitSpec11(this, _expectedLayersCount, -1);
    _classPrivateFieldInitSpec11(this, _activeSelectionLayer, 0);
    this.settings = settings;
    ...
    _classPrivateFieldSet11(_extenderTransformation, this, new ExtenderTransformation(this.selectedRange, {
      ...this.tableProps,
    ...
    _classPrivateFieldSet11(_focusTransformation, this, new FocusTransformation(this.selectedRange, {
      ...this.tableProps,
      navigableHeaders: () => settings.navigableHeaders,
      fixedRowsBottom: () => 0,
      minSpareRows: () => 0,
    ...
    _classPrivateFieldGet11(_extenderTransformation, this).addLocalHook("beforeTransformStart", function() {
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      return _this.runLocalHooks("beforeModifyTransformStart", ...args);
    });
    _classPrivateFieldGet11(_extenderTransformation, this).addLocalHook("afterTransformStart", function() {
      for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        args[_key2] = arguments[_key2];
      }
      return _this.runLocalHooks("afterModifyTransformStart", ...args);
    });
    _classPrivateFieldGet11(_extenderTransformation, this).addLocalHook("beforeTransformEnd", function() {
      for (var _len3 = arguments.length, args = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
        args[_key3] = arguments[_key3];
      }
      return _this.runLocalHooks("beforeModifyTransformEnd", ...args);
    });
    _classPrivateFieldGet11(_extenderTransformation, this).addLocalHook("afterTransformEnd", function() {
      for (var _len4 = arguments.length, args = new Array(_len4), _key4 = 0; _key4 < _len4; _key4++) {
        args[_key4] = arguments[_key4];
      }
      return _this.runLocalHooks("afterModifyTransformEnd", ...args);
    });
    _classPrivateFieldGet11(_extenderTransformation, this).addLocalHook("insertRowRequire", function() {
      for (var _len5 = arguments.length, args = new Array(_len5), _key5 = 0; _key5 < _len5; _key5++) {
        args[_key5] = arguments[_key5];
      }
      return _this.runLocalHooks("insertRowRequire", ...args);
    });
    _classPrivateFieldGet11(_extenderTransformation, this).addLocalHook("insertColRequire", function() {
      for (var _len6 = arguments.length, args = new Array(_len6), _key6 = 0; _key6 < _len6; _key6++) {
        args[_key6] = arguments[_key6];
      }
      return _this.runLocalHooks("insertColRequire", ...args);
    });
    _classPrivateFieldGet11(_extenderTransformation, this).addLocalHook("beforeRowWrap", function() {
      for (var _len7 = arguments.length, args = new Array(_len7), _key7 = 0; _key7 < _len7; _key7++) {
        args[_key7] = arguments[_key7];
      }
      return _this.runLocalHooks("beforeRowWrap", ...args);
    });
    _classPrivateFieldGet11(_extenderTransformation, this).addLocalHook("beforeColumnWrap", function() {
      for (var _len8 = arguments.length, args = new Array(_len8), _key8 = 0; _key8 < _len8; _key8++) {
        args[_key8] = arguments[_key8];
      }
      return _this.runLocalHooks("beforeColumnWrap", ...args);
    });
    _classPrivateFieldGet11(_focusTransformation, this).addLocalHook("beforeTransformStart", function() {
      for (var _len9 = arguments.length, args = new Array(_len9), _key9 = 0; _key9 < _len9; _key9++) {
        args[_key9] = arguments[_key9];
      }
      return _this.runLocalHooks("beforeModifyTransformFocus", ...args);
    });
    _classPrivateFieldGet11(_focusTransformation, this).addLocalHook("afterTransformStart", function() {
  ...
  getActiveSelectedRange() {
    return this.selectedRange.peekByIndex(_classPrivateFieldGet11(_activeSelectionLayer, this));
  }
  /**
  ...
  getActiveSelectionLayerIndex() {
    return _classPrivateFieldGet11(_activeSelectionLayer, this);
  }
  /**
  ...
  setActiveSelectionLayerIndex(layerIndex) {
    _classPrivateFieldSet11(_activeSelectionLayer, this, layerIndex);
  }
  /**
  ...
  markSource(sourceName) {
    _classPrivateFieldSet11(_selectionSource, this, sourceName);
  }
  /**
   * Marks end of the selection source. It restores the selection source to default value which is 'unknown'.
   */
  markEndSource() {
    _classPrivateFieldSet11(_selectionSource, this, "unknown");
  }
  /**
   ...
   */
  getSelectionSource() {
    return _classPrivateFieldGet11(_selectionSource, this);
  }
  /**
  ...
  setExpectedLayers(layersCount) {
    _classPrivateFieldSet11(_expectedLayersCount, this, layersCount);
  }
  /**
  ...
  finish() {
    ...
    _classPrivateFieldSet11(_expectedLayersCount, this, -1);
  }
  /**
  ...
  setRangeStart(coords, multipleSelection) {
    ...
    _classPrivateFieldSet11(_disableHeadersHighlight, this, false);
    _classPrivateFieldSet11(_isFocusSelectionChanged, this, false);
   ...
   */
  setRangeEnd(coords) {
    let layerIndex = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.getLayerLevel();
    ...
    const isLastLayer = _classPrivateFieldGet11(_expectedLayersCount, this) === -1 || this.selectedRange.size() === _classPrivateFieldGet11(_expectedLayersCount, this);
   ...
   */
  applyAndCommit() {
    let cellRange = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : this.getActiveSelectedRange();
    ...
    if (this.highlight.isEnabledFor(HEADER_TYPE, cellRange.highlight)) {
      ...
      const highlightRowHeaders = !_classPrivateFieldGet11(_disableHeadersHighlight, this) && this.isEntireRowSelected() && (countCols > 0 && countCols === cellRange.getWidth() || countCols === 0 && this.isSelectedByRowHeader());
      const highlightColumnHeaders = !_classPrivateFieldGet11(_disableHeadersHighlight, this) && this.isEntireColumnSelected() && (countRows > 0 && countRows === cellRange.getHeight() || countRows === 0 && this.isSelectedByColumnHeader());
  ...
  setRangeFocus(coords) {
    ...
    this.setActiveSelectionLayerIndex(layerIndex);
    _classPrivateFieldGet11(_extenderTransformation, this).setActiveLayerIndex(layerIndex);
    _classPrivateFieldGet11(_focusTransformation, this).setActiveLayerIndex(layerIndex);
    const cellRange = this.getActiveSelectedRange();
    if (!this.inProgress) {
    ...
    if (!this.inProgress) {
      _classPrivateFieldSet11(_isFocusSelectionChanged, this, true);
  ...
  transformStart(rowDelta, colDelta) {
    ...
    const {
      visualCoords
    } = _classPrivateFieldGet11(_extenderTransformation, this).transformStart(rowDelta, colDelta, createMissingRecords);
  ...
  transformEnd(rowDelta, colDelta) {
    const {
      visualCoords,
      selectionLayer
    } = _classPrivateFieldGet11(_extenderTransformation, this).transformEnd(rowDelta, colDelta);
  ...
  transformFocus(rowDelta, colDelta) {
    const {
      selectionLayer,
      visualCoords
    } = _classPrivateFieldGet11(_focusTransformation, this).transformStart(rowDelta, colDelta);
  ...
  isFocusSelectionChanged() {
    return this.isSelected() && _classPrivateFieldGet11(_isFocusSelectionChanged, this);
  }
  /**
  ...
  isEntireRowSelected() {
    ...
    if (layerLevel === -1) {
      return Array.from(this.selectedRange).some((range2) => tester2(range2));
    }
    const range = this.selectedRange.peekByIndex(layerLevel);
    return range ? tester2(range) : false;
  }
  /**
  ...
  selectAll() {
    ...
    _classPrivateFieldSet11(_disableHeadersHighlight, this, disableHeadersHighlight);
    if (columnFrom < 0) {
      this.selectedByRowHeader.add(this.getLayerLevel());
    }
    if (rowFrom < 0) {
  ...
  exportSelection() {
    return {
      ...
      disableHeadersHighlight: _classPrivateFieldGet11(_disableHeadersHighlight, this)
    };
  }
  /**
...
function mouseUp(_ref3) {
  ...
  if (!isLeftClick2 || selection.settings.selectionMode !== "multiple") {
    return;
  }
...
var handlers = /* @__PURE__ */ new Map([["touchstart", mouseDown], ["touchend", mouseUp], ["mousedown", mouseDown], ["mouseover", mouseOver], ["mouseup", mouseUp]]);
...
var GRID_SCOPE = "grid";
var GRID_TAB_NAVIGATION_GROUP = "grid.tabNavigation";
var EDITOR_EDIT_GROUP = "editorManager.handlingEditor";
var EDITOR_SCOPE = "editor";
...
var command29 = {
  ...
  callback(hot) {
    ...
    selection.markSource("keyboard");
    selection.setRangeStart(hot._createCellCoords(hot.getSelectedRangeActive().highlight.row, columnIndexMapper.getNearestNotHiddenIndex(hot.countCols() - 1, -1)));
    selection.markEndSource();
  }
};
...
// node_modules/handsontable/shortcutContexts/commands/tabNavigation.mjs
var command42 = {
  name: "tabNavigation",
  callback(hot) {
    const rowWrapState = {
...
var allCommands = [...getAllCommands(), ...getAllCommands2(), ...getAllCommands3(), command37, command38, command39, command40, command41, command42];
...
function shortcutsGridContext(hot) {
  ...
  context.addShortcuts([{
    ...
    runOnlyIf: () => {
      ...
      return isDefined(hot.getSelected()) && !((_hot$getSelectedRange = hot.getSelectedRangeActive()) !== null && _hot$getSelectedRange !== void 0 && _hot$getSelectedRange.highlight.isHeader());
    }
  }, {
    keys: [["Control/Meta", "A"]],
    callback: () => {
    ...
    runOnlyIf: () => {
      ...
      return isDefined(hot.getSelected()) && ((_hot$getSelectedRange2 = hot.getSelectedRangeActive()) === null || _hot$getSelectedRange2 === void 0 ? void 0 : _hot$getSelectedRange2.highlight.isHeader());
    },
    preventDefault: true
  }, {
    ...
    runOnlyIf: () => {
      return isDefined(hot.getSelected()) && !hot.getSelectedRangeActive().highlight.isHeader() && hot.getSelectedRangeActive().getCellsCount() > 1;
    }
  }, {
    keys: [["Control", "Space"]],
    captureCtrl: true,
    ...
    runOnlyIf: () => isDefined(hot.getSelected()) && !(hot.selection.isSelectedByCorner() || hot.selection.isSelectedByColumnHeader())
  }, {
    keys: [["ArrowDown"]],
    ...
    runOnlyIf: () => isDefined(hot.getSelected()) && !(hot.selection.isSelectedByCorner() || hot.selection.isSelectedByRowHeader())
  }, {
    keys: [["ArrowRight"]],
...
// node_modules/handsontable/utils/a11yAnnouncer.mjs
var announcerElement = null;
var installCounter = 0;
function install(rootPortalElement) {
  const document2 = rootPortalElement.ownerDocument;
  if (!announcerElement) {
    announcerElement = document2.createElement("div");
...
*/
//# sourceMappingURL=chunk-ANTXVLDJ.js.map
